...
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMask:1.0 packetMask_inst_5
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMask_inst_5/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMask_inst_5/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_4
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_4]
set_property -dict [list CONFIG.CONST_VAL {4}] [get_bd_cells id_4]
connect_bd_net [get_bd_pins id_4/dout] [get_bd_pins packetMask_inst_5/id_V]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMask:1.0 packetMask_inst_6
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMask_inst_6/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMask_inst_6/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_5
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_5]
set_property -dict [list CONFIG.CONST_VAL {5}] [get_bd_cells id_5]
connect_bd_net [get_bd_pins id_5/dout] [get_bd_pins packetMask_inst_6/id_V]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMask:1.0 packetMask_inst_7
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMask_inst_7/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMask_inst_7/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_6
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_6]
set_property -dict [list CONFIG.CONST_VAL {6}] [get_bd_cells id_6]
connect_bd_net [get_bd_pins id_6/dout] [get_bd_pins packetMask_inst_7/id_V]
...
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMaker:1.0 packetMaker_inst_3
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMaker_inst_3/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMaker_inst_3/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_12
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_12]
set_property -dict [list CONFIG.CONST_VAL {12}] [get_bd_cells id_12]
connect_bd_net [get_bd_pins id_12/dout] [get_bd_pins packetMaker_inst_3/id_V]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMaker:1.0 packetMaker_inst_4
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMaker_inst_4/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMaker_inst_4/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_15
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_15]
set_property -dict [list CONFIG.CONST_VAL {15}] [get_bd_cells id_15]
connect_bd_net [get_bd_pins id_15/dout] [get_bd_pins packetMaker_inst_4/id_V]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetMaker:1.0 packetMaker_inst_5
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetMaker_inst_5/ap_clk] 
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetMaker_inst_5/ap_rst_n]
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_16
set_property -dict [list CONFIG.CONST_WIDTH {32}] [get_bd_cells id_16]
set_property -dict [list CONFIG.CONST_VAL {16}] [get_bd_cells id_16]
connect_bd_net [get_bd_pins id_16/dout] [get_bd_pins packetMaker_inst_5/id_V]
endgroup
startgroup
...
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_3
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_3
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_3]
set_property -dict [list CONFIG.CONST_VAL {274973442034179}] [get_bd_cells pf_dst_inst_3]
connect_bd_net [get_bd_pins pf_dst_inst_3/dout] [get_bd_pins packetFormatter_inst_3/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_3/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_3/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_3/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_4
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_4
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_4]
set_property -dict [list CONFIG.CONST_VAL {274973442034179}] [get_bd_cells pf_dst_inst_4]
connect_bd_net [get_bd_pins pf_dst_inst_4/dout] [get_bd_pins packetFormatter_inst_4/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_4/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_4/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_4/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_5
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_5
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_5]
set_property -dict [list CONFIG.CONST_VAL {274973442034179}] [get_bd_cells pf_dst_inst_5]
connect_bd_net [get_bd_pins pf_dst_inst_5/dout] [get_bd_pins packetFormatter_inst_5/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_5/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_5/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_5/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_6
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_6
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_6]
set_property -dict [list CONFIG.CONST_VAL {274973442034179}] [get_bd_cells pf_dst_inst_6]
connect_bd_net [get_bd_pins pf_dst_inst_6/dout] [get_bd_pins packetFormatter_inst_6/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_6/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_6/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_6/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_7
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_7
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_7]
set_property -dict [list CONFIG.CONST_VAL {274973442034179}] [get_bd_cells pf_dst_inst_7]
connect_bd_net [get_bd_pins pf_dst_inst_7/dout] [get_bd_pins packetFormatter_inst_7/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_7/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_7/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_7/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_8
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_8
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_8]
set_property -dict [list CONFIG.CONST_VAL {274973453189119}] [get_bd_cells pf_dst_inst_8]
connect_bd_net [get_bd_pins pf_dst_inst_8/dout] [get_bd_pins packetFormatter_inst_8/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_8/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_8/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_8/eth_src_V] [get_bd_pins src_inst/dout]
create_bd_cell -type ip -vlnv xilinx.com:hls:packetFormatter_hardcode_64:1.0 packetFormatter_inst_9
create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pf_dst_inst_9
set_property -dict [list CONFIG.CONST_WIDTH {48}] [get_bd_cells pf_dst_inst_9]
set_property -dict [list CONFIG.CONST_VAL {274973453189119}] [get_bd_cells pf_dst_inst_9]
connect_bd_net [get_bd_pins pf_dst_inst_9/dout] [get_bd_pins packetFormatter_inst_9/eth_dst_V]
connect_bd_net [get_bd_nets CLK_DATA_1] [get_bd_ports CLK_DATA] [get_bd_pins packetFormatter_inst_9/ap_clk]
connect_bd_net -net [get_bd_nets ARESETN_1] [get_bd_ports ARESETN] [get_bd_pins packetFormatter_inst_9/ap_rst_n] 
connect_bd_net [get_bd_pins src_inst/dout] [get_bd_pins packetFormatter_inst_9/eth_src_V] [get_bd_pins src_inst/dout]
endgroup
startgroup
set_property -dict [list CONFIG.NUM_SI {11}] [get_bd_cells outputSwitch_inst]
...
endgroup
set_property -dict [list CONFIG.NUM_SI {18} CONFIG.NUM_MI {15} CONFIG.DECODER_REG {1}] [get_bd_cells inputSwitch_inst]
...
set_property -dict [list CONFIG.M00_AXIS_BASETDEST {0x00000001} CONFIG.M00_AXIS_HIGHTDEST {0x00000001} CONFIG.M01_AXIS_BASETDEST {0x00000002} CONFIG.M01_AXIS_HIGHTDEST {0x00000002} CONFIG.M02_AXIS_BASETDEST {0x00000001} CONFIG.M02_AXIS_HIGHTDEST {0x00000001} CONFIG.M03_AXIS_BASETDEST {0x00000002} CONFIG.M03_AXIS_HIGHTDEST {0x00000002} CONFIG.M04_AXIS_BASETDEST {0x00000005} CONFIG.M04_AXIS_HIGHTDEST {0x00000005} CONFIG.M05_AXIS_BASETDEST {0x00000006} CONFIG.M05_AXIS_HIGHTDEST {0x00000006} CONFIG.M06_AXIS_BASETDEST {0x00000004} CONFIG.M06_AXIS_HIGHTDEST {0x00000004} CONFIG.M07_AXIS_BASETDEST {0x00000005} CONFIG.M07_AXIS_HIGHTDEST {0x00000005} CONFIG.M08_AXIS_BASETDEST {0x00000006} CONFIG.M08_AXIS_HIGHTDEST {0x00000006} CONFIG.M09_AXIS_BASETDEST {0x00000001} CONFIG.M09_AXIS_HIGHTDEST {0x00000001} CONFIG.M10_AXIS_BASETDEST {0x00000002} CONFIG.M10_AXIS_HIGHTDEST {0x00000002} CONFIG.M11_AXIS_BASETDEST {0x00000003} CONFIG.M11_AXIS_HIGHTDEST {0x00000003} CONFIG.M12_AXIS_BASETDEST {0x00000009} CONFIG.M12_AXIS_HIGHTDEST {0x00000009} CONFIG.M13_AXIS_BASETDEST {0x0000000a} CONFIG.M13_AXIS_HIGHTDEST {0x0000000a} CONFIG.M14_AXIS_BASETDEST {0x0000000f} CONFIG.M14_AXIS_HIGHTDEST {0x0000000f} ] [get_bd_cells inputSwitch_inst]
...
startgroupcreate_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI
...
endgroupconnect_bd_net -net [get_bd_nets CLK_CONTROL_1] [get_bd_ports CLK_CONTROL] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
...
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_0/packetOut] [get_bd_intf_pins packetMask_inst_2/packetIn]
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_3/packetOut] [get_bd_intf_pins packetMask_inst_5/packetIn]
connect_bd_intf_net [get_bd_intf_pins sched_inst_0/M00_AXIS] [get_bd_intf_pins packetMask_inst_3/packetIn]
connect_bd_intf_net [get_bd_intf_pins sched_inst_0/M01_AXIS] [get_bd_intf_pins packetMask_inst_4/packetIn]
...
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_0/packetOut] [get_bd_intf_pins inputSwitch_inst/S08_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_1/packetOut] [get_bd_intf_pins inputSwitch_inst/S09_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_2/packetOut] [get_bd_intf_pins inputSwitch_inst/S10_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_3/packetOut] [get_bd_intf_pins inputSwitch_inst/S11_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_4/packetOut] [get_bd_intf_pins inputSwitch_inst/S12_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_5/packetOut] [get_bd_intf_pins inputSwitch_inst/S13_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_6/packetOut] [get_bd_intf_pins inputSwitch_inst/S14_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMask_inst_7/packetOut] [get_bd_intf_pins inputSwitch_inst/S15_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_1/packetOut] [get_bd_intf_pins inputSwitch_inst/S16_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_2/packetOut] [get_bd_intf_pins inputSwitch_inst/S17_AXIS]
...
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M02_AXIS] [get_bd_intf_pins packetMask_inst_0/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M03_AXIS] [get_bd_intf_pins packetMask_inst_1/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M04_AXIS] [get_bd_intf_pins packetMask_inst_6/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M05_AXIS] [get_bd_intf_pins packetMask_inst_7/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M06_AXIS] [get_bd_intf_pins packetFormatter_inst_0/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M07_AXIS] [get_bd_intf_pins packetFormatter_inst_1/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M08_AXIS] [get_bd_intf_pins packetFormatter_inst_2/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M09_AXIS] [get_bd_intf_pins packetFormatter_inst_3/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M10_AXIS] [get_bd_intf_pins packetFormatter_inst_4/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M11_AXIS] [get_bd_intf_pins packetFormatter_inst_5/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M12_AXIS] [get_bd_intf_pins packetFormatter_inst_6/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M13_AXIS] [get_bd_intf_pins packetFormatter_inst_7/packetIn]
connect_bd_intf_net [get_bd_intf_pins inputSwitch_inst/M14_AXIS] [get_bd_intf_pins roundRobin_inst_0/packetIn]
connect_bd_intf_net [get_bd_intf_pins roundRobin_inst_0/packetOut] [get_bd_intf_pins sched_inst_0/S00_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_4/packetOut] [get_bd_intf_pins packetFormatter_inst_8/packetIn]
connect_bd_intf_net [get_bd_intf_pins packetMaker_inst_5/packetOut] [get_bd_intf_pins packetFormatter_inst_9/packetIn]
...
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_3/packetOut] [get_bd_intf_pins outputSwitch_inst/S03_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_4/packetOut] [get_bd_intf_pins outputSwitch_inst/S04_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_5/packetOut] [get_bd_intf_pins outputSwitch_inst/S05_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_6/packetOut] [get_bd_intf_pins outputSwitch_inst/S06_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_7/packetOut] [get_bd_intf_pins outputSwitch_inst/S07_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_8/packetOut] [get_bd_intf_pins outputSwitch_inst/S08_AXIS]
connect_bd_intf_net [get_bd_intf_pins packetFormatter_inst_9/packetOut] [get_bd_intf_pins outputSwitch_inst/S09_AXIS]
connect_bd_intf_net [get_bd_intf_pins heartBeat_inst/stream_out] [get_bd_intf_pins outputSwitch_inst/S10_AXIS]
