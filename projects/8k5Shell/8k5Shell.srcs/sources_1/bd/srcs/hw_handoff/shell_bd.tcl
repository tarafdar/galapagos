...
CONFIG.NUM_MI {3} \
  ...
  # Create port connections
  connect_bd_net -net Clk_1 [get_bd_pins clk100] [get_bd_pins axi_hwicap_0/icap_clk] [get_bd_pins axi_hwicap_0/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
...
CONFIG.C_SIZE {1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PCIe_M_AXI [get_bd_intf_ports M_AXI] [get_bd_intf_pins PCIe/M_AXI]
  ...
  # Create port connections
  connect_bd_net -net PCIe_axi_aclk [get_bd_ports CLK_CONTROL] [get_bd_pins PCIe/axi_aclk]
  connect_bd_net -net PCIe_axi_aresetn [get_bd_pins PCIe/axi_aresetn] [get_bd_pins util_vector_logic_2/Op1]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins control/clk100] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins network/clk_100]
  ...
  connect_bd_net -net util_vector_logic_2_Res [get_bd_ports ARESETN] [get_bd_pins control/ext_reset_in] [get_bd_pins network/aresetn] [get_bd_pins reverseEndian64_0/ap_rst_n] [get_bd_pins reverseEndian64_1/ap_rst_n] [get_bd_pins util_vector_logic_2/Res]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces PCIe/xdma_0/M_AXI] [get_bd_addr_segs M_AXI/Reg] SEG_M_AXI_Reg
