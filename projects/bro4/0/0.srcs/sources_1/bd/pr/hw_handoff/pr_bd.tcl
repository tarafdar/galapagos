...
CONFIG.use_bram_block.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: id_1, and set properties
  set id_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_1 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {1} \
CONFIG.CONST_WIDTH {32} \
 ] $id_1

  # Create instance: id_2, and set properties
  set id_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_2 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {2} \
CONFIG.CONST_WIDTH {32} \
 ] $id_2

  # Create instance: id_3, and set properties
  set id_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_3 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {3} \
CONFIG.CONST_WIDTH {32} \
 ] $id_3

  # Create instance: id_9, and set properties
  set id_9 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_9 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {9} \
CONFIG.CONST_WIDTH {32} \
 ] $id_9

  # Create instance: id_10, and set properties
  set id_10 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_10 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {10} \
CONFIG.CONST_WIDTH {32} \
 ] $id_10

  # Create instance: id_11, and set properties
  set id_11 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_11 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {11} \
CONFIG.CONST_WIDTH {32} \
 ] $id_11

  # Create instance: id_13, and set properties
  set id_13 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_13 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {13} \
CONFIG.CONST_WIDTH {32} \
 ] $id_13

  # Create instance: id_14, and set properties
  set id_14 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 id_14 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {14} \
CONFIG.CONST_WIDTH {32} \
 ] $id_14
...
CONFIG.M03_AXIS_BASETDEST {0x00000005} \
CONFIG.M03_AXIS_HIGHTDEST {0x00000005} \
CONFIG.M04_AXIS_BASETDEST {0x00000006} \
CONFIG.M04_AXIS_HIGHTDEST {0x00000006} \
CONFIG.M05_AXIS_BASETDEST {0x0000000f} \
CONFIG.M05_AXIS_HIGHTDEST {0x0000000f} \
CONFIG.NUM_MI {6} \
CONFIG.NUM_SI {8} \
...
CONFIG.TDATA_NUM_BYTES {8} \
  ...
  # Create instance: packetMask_inst_3, and set properties
  set packetMask_inst_3 [ create_bd_cell -type ip -vlnv xilinx.com:hls:packetMask:1.0 packetMask_inst_3 ]

  # Create instance: packetMask_inst_4, and set properties
  set packetMask_inst_4 [ create_bd_cell -type ip -vlnv xilinx.com:hls:packetMask:1.0 packetMask_inst_4 ]
...
CONFIG.TDATA_NUM_BYTES {8} \
  ...
  # Create instance: roundRobinBase_inst_0, and set properties
  set roundRobinBase_inst_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 roundRobinBase_inst_0 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {9} \
CONFIG.CONST_WIDTH {8} \
 ] $roundRobinBase_inst_0

  # Create instance: roundRobinMax_inst_0, and set properties
  set roundRobinMax_inst_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 roundRobinMax_inst_0 ]
  set_property -dict [ list \
CONFIG.CONST_VAL {10} \
CONFIG.CONST_WIDTH {8} \
 ] $roundRobinMax_inst_0

  # Create instance: roundRobin_inst_0, and set properties
  set roundRobin_inst_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:roundRobin:1.0 roundRobin_inst_0 ]

  # Create instance: sched_inst_0, and set properties
  set sched_inst_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_switch:1.1 sched_inst_0 ]
  set_property -dict [ list \
CONFIG.DECODER_REG {1} \
CONFIG.NUM_MI {2} \
CONFIG.NUM_SI {1} \
...
CONFIG.CONST_WIDTH {48} \
  ...
  connect_bd_intf_net -intf_net heartBeat_inst_stream_out [get_bd_intf_pins heartBeat_inst/stream_out] [get_bd_intf_pins outputSwitch_inst/S03_AXIS]
  connect_bd_intf_net -intf_net inputSwitch_inst_M00_AXIS [get_bd_intf_pins inputSwitch_inst/M00_AXIS] [get_bd_intf_pins packetMask_inst_0/packetIn]
  connect_bd_intf_net -intf_net inputSwitch_inst_M01_AXIS [get_bd_intf_pins inputSwitch_inst/M01_AXIS] [get_bd_intf_pins packetMask_inst_1/packetIn]
  ...
  connect_bd_intf_net -intf_net inputSwitch_inst_M05_AXIS [get_bd_intf_pins inputSwitch_inst/M05_AXIS] [get_bd_intf_pins roundRobin_inst_0/packetIn]
  ...
  connect_bd_intf_net -intf_net packetMaker_inst_0_packetOut [get_bd_intf_pins packetMaker_inst_0/packetOut] [get_bd_intf_pins packetMask_inst_2/packetIn]
  connect_bd_intf_net -intf_net packetMaker_inst_1_packetOut [get_bd_intf_pins inputSwitch_inst/S06_AXIS] [get_bd_intf_pins packetMaker_inst_1/packetOut]
  connect_bd_intf_net -intf_net packetMaker_inst_2_packetOut [get_bd_intf_pins inputSwitch_inst/S07_AXIS] [get_bd_intf_pins packetMaker_inst_2/packetOut]
  ...
  connect_bd_intf_net -intf_net packetMask_inst_3_packetOut [get_bd_intf_pins inputSwitch_inst/S04_AXIS] [get_bd_intf_pins packetMask_inst_3/packetOut]
  connect_bd_intf_net -intf_net packetMask_inst_4_packetOut [get_bd_intf_pins inputSwitch_inst/S05_AXIS] [get_bd_intf_pins packetMask_inst_4/packetOut]
  ...
  connect_bd_intf_net -intf_net roundRobin_inst_0_packetOut [get_bd_intf_pins roundRobin_inst_0/packetOut] [get_bd_intf_pins sched_inst_0/S00_AXIS]
  connect_bd_intf_net -intf_net sched_inst_0_M00_AXIS [get_bd_intf_pins packetMask_inst_3/packetIn] [get_bd_intf_pins sched_inst_0/M00_AXIS]
  connect_bd_intf_net -intf_net sched_inst_0_M01_AXIS [get_bd_intf_pins packetMask_inst_4/packetIn] [get_bd_intf_pins sched_inst_0/M01_AXIS]
  connect_bd_intf_net -intf_net sendFifo_inst_M_AXIS [get_bd_intf_ports M_AXIS] [get_bd_intf_pins sendFifo_inst/M_AXIS]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_ports ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins fireWall2_inst/ap_rst_n] [get_bd_pins fireWall_inst/ap_rst_n] [get_bd_pins heartBeat_inst/ap_rst_n] [get_bd_pins inputSwitch_inst/aresetn] [get_bd_pins outputSwitch_inst/aresetn] [get_bd_pins packetFormatter_inst_0/ap_rst_n] [get_bd_pins packetFormatter_inst_1/ap_rst_n] [get_bd_pins packetFormatter_inst_2/ap_rst_n] [get_bd_pins packetMaker_inst_0/ap_rst_n] [get_bd_pins packetMaker_inst_1/ap_rst_n] [get_bd_pins packetMaker_inst_2/ap_rst_n] [get_bd_pins packetMask_inst_0/ap_rst_n] [get_bd_pins packetMask_inst_1/ap_rst_n] [get_bd_pins packetMask_inst_2/ap_rst_n] [get_bd_pins packetMask_inst_3/ap_rst_n] [get_bd_pins packetMask_inst_4/ap_rst_n] [get_bd_pins receiveFifo_inst/s_axis_aresetn] [get_bd_pins roundRobin_inst_0/ap_rst_n] [get_bd_pins sched_inst_0/aresetn] [get_bd_pins sendFifo_inst/s_axis_aresetn]
  connect_bd_net -net CLK_CONTROL_1 [get_bd_ports CLK_CONTROL] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk]
  connect_bd_net -net CLK_DATA_1 [get_bd_ports CLK_DATA] [get_bd_pins fireWall2_inst/ap_clk] [get_bd_pins fireWall_inst/ap_clk] [get_bd_pins heartBeat_inst/ap_clk] [get_bd_pins inputSwitch_inst/aclk] [get_bd_pins outputSwitch_inst/aclk] [get_bd_pins packetFormatter_inst_0/ap_clk] [get_bd_pins packetFormatter_inst_1/ap_clk] [get_bd_pins packetFormatter_inst_2/ap_clk] [get_bd_pins packetMaker_inst_0/ap_clk] [get_bd_pins packetMaker_inst_1/ap_clk] [get_bd_pins packetMaker_inst_2/ap_clk] [get_bd_pins packetMask_inst_0/ap_clk] [get_bd_pins packetMask_inst_1/ap_clk] [get_bd_pins packetMask_inst_2/ap_clk] [get_bd_pins packetMask_inst_3/ap_clk] [get_bd_pins packetMask_inst_4/ap_clk] [get_bd_pins receiveFifo_inst/s_axis_aclk] [get_bd_pins roundRobin_inst_0/ap_clk] [get_bd_pins sched_inst_0/aclk] [get_bd_pins sendFifo_inst/s_axis_aclk]
  ...
  connect_bd_net -net id_10_dout [get_bd_pins id_10/dout] [get_bd_pins packetMask_inst_4/id_V]
  connect_bd_net -net id_11_dout [get_bd_pins id_11/dout] [get_bd_pins packetMaker_inst_0/id_V]
  connect_bd_net -net id_13_dout [get_bd_pins id_13/dout] [get_bd_pins packetMaker_inst_1/id_V]
  connect_bd_net -net id_14_dout [get_bd_pins id_14/dout] [get_bd_pins packetMaker_inst_2/id_V]
  connect_bd_net -net id_1_dout [get_bd_pins id_1/dout] [get_bd_pins packetMask_inst_0/id_V]
  connect_bd_net -net id_2_dout [get_bd_pins id_2/dout] [get_bd_pins packetMask_inst_1/id_V]
  connect_bd_net -net id_3_dout [get_bd_pins id_3/dout] [get_bd_pins packetMask_inst_2/id_V]
  connect_bd_net -net id_9_dout [get_bd_pins id_9/dout] [get_bd_pins packetMask_inst_3/id_V]
  ...
  connect_bd_net -net roundRobinBase_inst_0_dout [get_bd_pins roundRobinBase_inst_0/dout] [get_bd_pins roundRobin_inst_0/base_V]
  connect_bd_net -net roundRobinMax_inst_0_dout [get_bd_pins roundRobinMax_inst_0/dout] [get_bd_pins roundRobin_inst_0/max_V]
  connect_bd_net -net src_inst_dout [get_bd_pins fireWall_inst/eth_address_V] [get_bd_pins heartBeat_inst/eth_address_V] [get_bd_pins packetFormatter_inst_0/eth_src_V] [get_bd_pins packetFormatter_inst_1/eth_src_V] [get_bd_pins packetFormatter_inst_2/eth_src_V] [get_bd_pins src_inst/dout]
