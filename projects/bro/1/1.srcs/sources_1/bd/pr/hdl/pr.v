...
(* CORE_GENERATION_INFO = "pr,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pr,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=37,numReposBlks=37,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=16,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "pr.hwdef" *) 
module pr
   (ARESETN,
    CLK_CONTROL,
    CLK_DATA,
  ...
  wire [7:7]heartBeat_inst_stream_out_TREADY;
  wire heartBeat_inst_stream_out_TVALID;
  wire [31:0]id_12_dout;
  wire [31:0]id_15_dout;
  wire [31:0]id_16_dout;
  wire [31:0]id_4_dout;
  wire [31:0]id_5_dout;
  wire [31:0]id_6_dout;
  ...
  wire [47:40]inputSwitch_inst_M05_AXIS_TKEEP;
  wire [5:5]inputSwitch_inst_M05_AXIS_TLAST;
  wire inputSwitch_inst_M05_AXIS_TREADY;
  wire [5:5]inputSwitch_inst_M05_AXIS_TVALID;
  wire [447:384]inputSwitch_inst_M06_AXIS_TDATA;
  wire [55:48]inputSwitch_inst_M06_AXIS_TDEST;
  wire [55:48]inputSwitch_inst_M06_AXIS_TKEEP;
  wire [6:6]inputSwitch_inst_M06_AXIS_TLAST;
  wire inputSwitch_inst_M06_AXIS_TREADY;
  wire [6:6]inputSwitch_inst_M06_AXIS_TVALID;
  ...
  wire [63:0]packetFormatter_inst_3_packetOut_TDATA;
  wire [7:0]packetFormatter_inst_3_packetOut_TKEEP;
  wire [0:0]packetFormatter_inst_3_packetOut_TLAST;
  wire [3:3]packetFormatter_inst_3_packetOut_TREADY;
  wire packetFormatter_inst_3_packetOut_TVALID;
  wire [63:0]packetFormatter_inst_4_packetOut_TDATA;
  wire [7:0]packetFormatter_inst_4_packetOut_TKEEP;
  wire [0:0]packetFormatter_inst_4_packetOut_TLAST;
  wire [4:4]packetFormatter_inst_4_packetOut_TREADY;
  wire packetFormatter_inst_4_packetOut_TVALID;
  wire [63:0]packetFormatter_inst_5_packetOut_TDATA;
  wire [7:0]packetFormatter_inst_5_packetOut_TKEEP;
  wire [0:0]packetFormatter_inst_5_packetOut_TLAST;
  wire [5:5]packetFormatter_inst_5_packetOut_TREADY;
  wire packetFormatter_inst_5_packetOut_TVALID;
  wire [63:0]packetFormatter_inst_6_packetOut_TDATA;
  wire [7:0]packetFormatter_inst_6_packetOut_TKEEP;
  wire [0:0]packetFormatter_inst_6_packetOut_TLAST;
  wire [6:6]packetFormatter_inst_6_packetOut_TREADY;
  wire packetFormatter_inst_6_packetOut_TVALID;
  ...
  wire packetMaker_inst_1_packetOut_TREADY;
  ...
  wire packetMaker_inst_2_packetOut_TREADY;
  ...
  wire [47:0]pf_dst_inst_3_dout;
  wire [47:0]pf_dst_inst_4_dout;
  wire [47:0]pf_dst_inst_5_dout;
  wire [47:0]pf_dst_inst_6_dout;
  ...
  wire [55:0]NLW_inputSwitch_inst_m_axis_tdest_UNCONNECTED;
  ...
  pr_inputSwitch_inst_0 inputSwitch_inst
       (.aclk(CLK_DATA_1),
        .aresetn(ARESETN_1),
        .m_axis_tdata({inputSwitch_inst_M06_AXIS_TDATA,inputSwitch_inst_M05_AXIS_TDATA,inputSwitch_inst_M04_AXIS_TDATA,inputSwitch_inst_M03_AXIS_TDATA,inputSwitch_inst_M02_AXIS_TDATA,inputSwitch_inst_M01_AXIS_TDATA,inputSwitch_inst_M00_AXIS_TDATA}),
        .m_axis_tdest({inputSwitch_inst_M06_AXIS_TDEST,inputSwitch_inst_M05_AXIS_TDEST,inputSwitch_inst_M04_AXIS_TDEST,inputSwitch_inst_M03_AXIS_TDEST,inputSwitch_inst_M02_AXIS_TDEST,NLW_inputSwitch_inst_m_axis_tdest_UNCONNECTED[15:0]}),
        .m_axis_tkeep({inputSwitch_inst_M06_AXIS_TKEEP,inputSwitch_inst_M05_AXIS_TKEEP,inputSwitch_inst_M04_AXIS_TKEEP,inputSwitch_inst_M03_AXIS_TKEEP,inputSwitch_inst_M02_AXIS_TKEEP,inputSwitch_inst_M01_AXIS_TKEEP,inputSwitch_inst_M00_AXIS_TKEEP}),
        .m_axis_tlast({inputSwitch_inst_M06_AXIS_TLAST,inputSwitch_inst_M05_AXIS_TLAST,inputSwitch_inst_M04_AXIS_TLAST,inputSwitch_inst_M03_AXIS_TLAST,inputSwitch_inst_M02_AXIS_TLAST,inputSwitch_inst_M01_AXIS_TLAST,inputSwitch_inst_M00_AXIS_TLAST}),
        .m_axis_tready({inputSwitch_inst_M06_AXIS_TREADY,inputSwitch_inst_M05_AXIS_TREADY,inputSwitch_inst_M04_AXIS_TREADY,inputSwitch_inst_M03_AXIS_TREADY,inputSwitch_inst_M02_AXIS_TREADY,inputSwitch_inst_M01_AXIS_TREADY,inputSwitch_inst_M00_AXIS_TREADY}),
        .m_axis_tvalid({inputSwitch_inst_M06_AXIS_TVALID,inputSwitch_inst_M05_AXIS_TVALID,inputSwitch_inst_M04_AXIS_TVALID,inputSwitch_inst_M03_AXIS_TVALID,inputSwitch_inst_M02_AXIS_TVALID,inputSwitch_inst_M01_AXIS_TVALID,inputSwitch_inst_M00_AXIS_TVALID}),
        .s_axis_tdata({packetMask_inst_2_packetOut_TDATA,packetMask_inst_1_packetOut_TDATA,packetMask_inst_0_packetOut_TDATA,fireWall2_inst_stream_out_TDATA}),
        .s_axis_tdest({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,fireWall2_inst_stream_out_TDEST}),
        .s_axis_tkeep({packetMask_inst_2_packetOut_TKEEP,packetMask_inst_1_packetOut_TKEEP,packetMask_inst_0_packetOut_TKEEP,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_tlast({packetMask_inst_2_packetOut_TLAST,packetMask_inst_1_packetOut_TLAST,packetMask_inst_0_packetOut_TLAST,fireWall2_inst_stream_out_TLAST}),
        .s_axis_tready({packetMask_inst_2_packetOut_TREADY,packetMask_inst_1_packetOut_TREADY,packetMask_inst_0_packetOut_TREADY,fireWall2_inst_stream_out_TREADY}),
        .s_axis_tvalid({packetMask_inst_2_packetOut_TVALID,packetMask_inst_1_packetOut_TVALID,packetMask_inst_0_packetOut_TVALID,fireWall2_inst_stream_out_TVALID}));
  ...
  pr_outputSwitch_inst_0 outputSwitch_inst
       (.aclk(CLK_DATA_1),
        ...
        .s_axis_tdata({heartBeat_inst_stream_out_TDATA,packetFormatter_inst_6_packetOut_TDATA,packetFormatter_inst_5_packetOut_TDATA,packetFormatter_inst_4_packetOut_TDATA,packetFormatter_inst_3_packetOut_TDATA,packetFormatter_inst_2_packetOut_TDATA,packetFormatter_inst_1_packetOut_TDATA,packetFormatter_inst_0_packetOut_TDATA}),
        .s_axis_tkeep({heartBeat_inst_stream_out_TKEEP,packetFormatter_inst_6_packetOut_TKEEP,packetFormatter_inst_5_packetOut_TKEEP,packetFormatter_inst_4_packetOut_TKEEP,packetFormatter_inst_3_packetOut_TKEEP,packetFormatter_inst_2_packetOut_TKEEP,packetFormatter_inst_1_packetOut_TKEEP,packetFormatter_inst_0_packetOut_TKEEP}),
        .s_axis_tlast({heartBeat_inst_stream_out_TLAST,packetFormatter_inst_6_packetOut_TLAST,packetFormatter_inst_5_packetOut_TLAST,packetFormatter_inst_4_packetOut_TLAST,packetFormatter_inst_3_packetOut_TLAST,packetFormatter_inst_2_packetOut_TLAST,packetFormatter_inst_1_packetOut_TLAST,packetFormatter_inst_0_packetOut_TLAST}),
        .s_axis_tready({heartBeat_inst_stream_out_TREADY,packetFormatter_inst_6_packetOut_TREADY,packetFormatter_inst_5_packetOut_TREADY,packetFormatter_inst_4_packetOut_TREADY,packetFormatter_inst_3_packetOut_TREADY,packetFormatter_inst_2_packetOut_TREADY,packetFormatter_inst_1_packetOut_TREADY,packetFormatter_inst_0_packetOut_TREADY}),
        .s_axis_tvalid({heartBeat_inst_stream_out_TVALID,packetFormatter_inst_6_packetOut_TVALID,packetFormatter_inst_5_packetOut_TVALID,packetFormatter_inst_4_packetOut_TVALID,packetFormatter_inst_3_packetOut_TVALID,packetFormatter_inst_2_packetOut_TVALID,packetFormatter_inst_1_packetOut_TVALID,packetFormatter_inst_0_packetOut_TVALID}),
  ...
  pr_packetFormatter_inst_3_0 packetFormatter_inst_3
       (.ap_clk(CLK_DATA_1),
        .ap_rst_n(ARESETN_1),
        .eth_dst_V(pf_dst_inst_3_dout),
        .eth_src_V(src_inst_dout),
        .packetIn_TDATA(inputSwitch_inst_M05_AXIS_TDATA),
        .packetIn_TDEST(inputSwitch_inst_M05_AXIS_TDEST),
        .packetIn_TKEEP(inputSwitch_inst_M05_AXIS_TKEEP),
        ...
        .packetOut_TDATA(packetFormatter_inst_3_packetOut_TDATA),
        .packetOut_TKEEP(packetFormatter_inst_3_packetOut_TKEEP),
        .packetOut_TLAST(packetFormatter_inst_3_packetOut_TLAST),
        .packetOut_TREADY(packetFormatter_inst_3_packetOut_TREADY),
        .packetOut_TVALID(packetFormatter_inst_3_packetOut_TVALID));
  pr_packetFormatter_inst_4_0 packetFormatter_inst_4
       (.ap_clk(CLK_DATA_1),
        .ap_rst_n(ARESETN_1),
        .eth_dst_V(pf_dst_inst_4_dout),
        .eth_src_V(src_inst_dout),
        .packetIn_TDATA(inputSwitch_inst_M06_AXIS_TDATA),
        .packetIn_TDEST(inputSwitch_inst_M06_AXIS_TDEST),
        .packetIn_TKEEP(inputSwitch_inst_M06_AXIS_TKEEP),
        .packetIn_TLAST(inputSwitch_inst_M06_AXIS_TLAST),
        .packetIn_TREADY(inputSwitch_inst_M06_AXIS_TREADY),
        .packetIn_TVALID(inputSwitch_inst_M06_AXIS_TVALID),
        .packetOut_TDATA(packetFormatter_inst_4_packetOut_TDATA),
        .packetOut_TKEEP(packetFormatter_inst_4_packetOut_TKEEP),
        .packetOut_TLAST(packetFormatter_inst_4_packetOut_TLAST),
        .packetOut_TREADY(packetFormatter_inst_4_packetOut_TREADY),
        .packetOut_TVALID(packetFormatter_inst_4_packetOut_TVALID));
  pr_packetFormatter_inst_5_0 packetFormatter_inst_5
       (.ap_clk(CLK_DATA_1),
        .ap_rst_n(ARESETN_1),
        .eth_dst_V(pf_dst_inst_5_dout),
        .eth_src_V(src_inst_dout),
        .packetIn_TDATA(packetMaker_inst_1_packetOut_TDATA),
        .packetIn_TDEST(packetMaker_inst_1_packetOut_TDEST),
        .packetIn_TKEEP({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .packetIn_TLAST(packetMaker_inst_1_packetOut_TLAST),
        .packetIn_TREADY(packetMaker_inst_1_packetOut_TREADY),
        .packetIn_TVALID(packetMaker_inst_1_packetOut_TVALID),
        .packetOut_TDATA(packetFormatter_inst_5_packetOut_TDATA),
        .packetOut_TKEEP(packetFormatter_inst_5_packetOut_TKEEP),
        .packetOut_TLAST(packetFormatter_inst_5_packetOut_TLAST),
        .packetOut_TREADY(packetFormatter_inst_5_packetOut_TREADY),
        .packetOut_TVALID(packetFormatter_inst_5_packetOut_TVALID));
  pr_packetFormatter_inst_6_0 packetFormatter_inst_6
       (.ap_clk(CLK_DATA_1),
        .ap_rst_n(ARESETN_1),
        .eth_dst_V(pf_dst_inst_6_dout),
        .eth_src_V(src_inst_dout),
        .packetIn_TDATA(packetMaker_inst_2_packetOut_TDATA),
        .packetIn_TDEST(packetMaker_inst_2_packetOut_TDEST),
        .packetIn_TKEEP({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .packetIn_TLAST(packetMaker_inst_2_packetOut_TLAST),
        .packetIn_TREADY(packetMaker_inst_2_packetOut_TREADY),
        .packetIn_TVALID(packetMaker_inst_2_packetOut_TVALID),
        .packetOut_TDATA(packetFormatter_inst_6_packetOut_TDATA),
        .packetOut_TKEEP(packetFormatter_inst_6_packetOut_TKEEP),
        .packetOut_TLAST(packetFormatter_inst_6_packetOut_TLAST),
        .packetOut_TREADY(packetFormatter_inst_6_packetOut_TREADY),
        .packetOut_TVALID(packetFormatter_inst_6_packetOut_TVALID));
  ...
  pr_pf_dst_inst_3_0 pf_dst_inst_3
       (.dout(pf_dst_inst_3_dout));
  pr_pf_dst_inst_4_0 pf_dst_inst_4
       (.dout(pf_dst_inst_4_dout));
  pr_pf_dst_inst_5_0 pf_dst_inst_5
       (.dout(pf_dst_inst_5_dout));
  pr_pf_dst_inst_6_0 pf_dst_inst_6
       (.dout(pf_dst_inst_6_dout));
