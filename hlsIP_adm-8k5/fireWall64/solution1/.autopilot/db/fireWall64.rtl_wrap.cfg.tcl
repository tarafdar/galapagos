...
set DataType1 [list "ap_axis_in" "struct ap_axis_in" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
...
set DataType2 [list "ap_axis_out" "struct ap_axis_out" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
set Port2 [list $PortName2 $Interface2 $DataType2 $Pointer2 $Dims2 $Const2 $Volatile2 $ArrayOpt2]
lappend PortList $Port2
set PortName3 "observedAddress_out"
set BitWidth3 "64"
set ArrayOpt3 ""
set Const3 "0"
set Volatile3 "0"
