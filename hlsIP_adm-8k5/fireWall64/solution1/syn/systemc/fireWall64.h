...
#ifndef _fireWall64_HH_
#define _fireWall64_HH_
...
struct fireWall64 : public sc_module {
    ...
    sc_in< sc_lv<48> > observedAddress_out_V;
    sc_out< sc_lv<16> > dest_out_V;
    sc_out< sc_logic > dest_out_V_ap_vld;
    sc_out< sc_lv<1> > match_out_V;
    sc_out< sc_logic > match_out_V_ap_vld;


    // Module declarations
    fireWall64(sc_module_name name);
    SC_HAS_PROCESS(fireWall64);
    ...
    sc_signal< sc_lv<2> > i_1_fu_180_p2;
    sc_signal< sc_lv<2> > i_1_reg_361;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<1> > tmp_2_fu_186_p1;
    sc_signal< sc_lv<1> > tmp_2_reg_366;
    sc_signal< sc_lv<1> > exitcond_fu_174_p2;
    sc_signal< sc_lv<8> > packetOut_dest_V_fu_207_p4;
    sc_signal< sc_lv<8> > packetOut_dest_V_reg_372;
    sc_signal< sc_lv<1> > tmp_last_V_reg_377;
    sc_signal< sc_lv<64> > x_V_fu_325_p9;
    sc_signal< sc_lv<2> > i_reg_153;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<64> > p_Val2_s_fu_104;
    sc_signal< sc_lv<64> > p_Val2_2_fu_229_p3;
    sc_signal< sc_lv<64> > p_Val2_1_fu_108;
    sc_signal< sc_lv<64> > header_1_V_1_fu_222_p3;
    sc_signal< sc_lv<48> > observedAddress_V_fu_190_p4;
    sc_signal< sc_lv<8> > tmp_10_fu_251_p1;
    sc_signal< sc_lv<8> > tmp_4_fu_265_p4;
    sc_signal< sc_lv<8> > tmp_7_fu_295_p4;
    sc_signal< sc_lv<8> > tmp_5_fu_275_p4;
    sc_signal< sc_lv<8> > tmp_8_fu_305_p4;
    sc_signal< sc_lv<8> > tmp_6_fu_285_p4;
    sc_signal< sc_lv<8> > tmp_9_fu_315_p4;
    sc_signal< sc_lv<8> > tmp_3_fu_255_p4;
    ...
    void thread_dest_out_V();
    void thread_dest_out_V_ap_vld();
    void thread_exitcond_fu_174_p2();
    void thread_header_1_V_1_fu_222_p3();
    void thread_i_1_fu_180_p2();
    void thread_match_out_V();
    void thread_match_out_V_ap_vld();
    void thread_observedAddress_V_fu_190_p4();
    void thread_p_Val2_2_fu_229_p3();
    void thread_packetOut_dest_V_fu_207_p4();
    ...
    void thread_tmp_10_fu_251_p1();
    void thread_tmp_2_fu_186_p1();
    void thread_tmp_3_fu_255_p4();
    void thread_tmp_4_fu_265_p4();
    void thread_tmp_5_fu_275_p4();
    void thread_tmp_6_fu_285_p4();
    void thread_tmp_7_fu_295_p4();
    void thread_tmp_8_fu_305_p4();
    void thread_tmp_9_fu_315_p4();
    void thread_x_V_fu_325_p9();
