...
(* CORE_GENERATION_INFO="axiStreamGate,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.140000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=273,HLS_SYN_LUT=370}" *)
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_283)) begin
            if ((1'b0 == ap_block_state4_io)) begin
                ap_reg_ioackin_programSafe_dummy_ack <= 1'b0;
...
always @ (posedge ap_clk) begin
    if ((~((packetOut_V_data_V_1_ack_in == 1'b0) | (packetIn_TVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((tmp_1_reg_127 == 1'd1) & (tmp_reg_123 == 1'd1) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & ((tmp_last_V_reg_136 == 1'd1) | (tmp_1_reg_127 == 1'd0) | (tmp_reg_123 == 1'd0)))) begin
        programSafe = 32'd1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((ap_reg_ioackin_programSafe_dummy_ack == 1'b0) & (1'b1 == ap_CS_fsm_state4) & ((tmp_last_V_reg_136 == 1'd1) | (tmp_1_reg_127 == 1'd0) | (tmp_reg_123 == 1'd0))))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_1_nbreadreq_fu_66_p5 == 1'd1) & (tmp_fu_102_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b0 == ap_block_state4_io) & (1'b1 == ap_CS_fsm_state4) & ((tmp_last_V_reg_136 == 1'd1) | (tmp_1_reg_127 == 1'd0) | (tmp_reg_123 == 1'd0)))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else if (((tmp_1_reg_127 == 1'd1) & (tmp_reg_123 == 1'd1) & (tmp_last_V_reg_136 == 1'd0) & (1'b0 == ap_block_state4_io) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end
...
always @ (*) begin
    ap_block_state4_io = ((ap_predicate_op34_write_state4 == 1'b1) & (packetOut_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_condition_283 = ((1'b1 == ap_CS_fsm_state4) & ((tmp_last_V_reg_136 == 1'd1) | (tmp_1_reg_127 == 1'd0) | (tmp_reg_123 == 1'd0)));
end

always @ (*) begin
    ap_predicate_op34_write_state4 = ((tmp_1_reg_127 == 1'd1) & (tmp_reg_123 == 1'd1));
end
...
assign tmp_fu_102_p2 = ((programming == 32'd0) ? 1'b1 : 1'b0);
