; ModuleID = '/home/tarafdar/workDir/galapagos/hlsIP_adm-8k5/conv_proj/solution1/.autopilot/db/a.o.2.bc'
...
define void @conv_layer(float* %mem, i32 %input_offset, i32 %output_offset, i32 %b, i32 %od, i32 %ox, i32 %oy, i32 %id, i32 %ix, i32 %iy, i32 %s, i32 %k) nounwind uwtable {
  ...
  %tmp1 = mul i32 %id, %od, !dbg !139             ; [#uses=1 type=i32] [debug line = 35:29]
  %tmp2 = mul i32 %k, %k, !dbg !139               ; [#uses=1 type=i32] [debug line = 35:29]
  %num_weights = mul i32 %tmp1, %tmp2, !dbg !139  ; [#uses=1 type=i32] [debug line = 35:29]
  ...
  %tmp. = sext i30 %tmp.6 to i62, !dbg !143       ; [#uses=1 type=i62] [debug line = 53:86]
  %tmp.3 = zext i62 %tmp. to i64, !dbg !143       ; [#uses=3 type=i64] [debug line = 53:86]
  %tmp.4.cast = sext i32 %num_weights to i33, !dbg !152 ; [#uses=2 type=i33] [debug line = 66:17]
  %tmp.5.cast = sext i32 %od to i33, !dbg !159    ; [#uses=1 type=i33] [debug line = 72:87]
  %tmp.1 = lshr i32 %output_offset, 2, !dbg !159  ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.4 = trunc i32 %tmp.1 to i30, !dbg !159     ; [#uses=1 type=i30] [debug line = 72:87]
  %tmp.5 = sext i30 %tmp.4 to i62, !dbg !159      ; [#uses=1 type=i62] [debug line = 72:87]
  %tmp.7 = zext i62 %tmp.5 to i64, !dbg !159      ; [#uses=1 type=i64] [debug line = 72:87]
  br label %1, !dbg !160                          ; [debug line = 41:16]

; <label>:1                                       ; preds = %14, %0
  %b_ = phi i31 [ 0, %0 ], [ %b_.1, %14 ]         ; [#uses=2 type=i31]
  %b_.cast = zext i31 %b_ to i32, !dbg !160       ; [#uses=3 type=i32] [debug line = 41:16]
  %tmp.8 = icmp slt i32 %b_.cast, %b, !dbg !160   ; [#uses=1 type=i1] [debug line = 41:16]
  br i1 %tmp.8, label %.preheader2.preheader, label %15, !dbg !160 ; [debug line = 41:16]

.preheader2.preheader:                            ; preds = %1
  %tmp3 = mul i32 %id, %ix, !dbg !152             ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp4 = mul i32 %b_.cast, %iy, !dbg !152        ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.9 = mul i32 %tmp3, %tmp4, !dbg !152        ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.11.cast = sext i32 %tmp.9 to i33, !dbg !159 ; [#uses=1 type=i33] [debug line = 72:87]
  %tmp5 = mul i32 %od, %ox, !dbg !159             ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp6 = mul i32 %b_.cast, %oy, !dbg !159        ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.10 = mul i32 %tmp5, %tmp6, !dbg !159       ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.15.cast = sext i32 %tmp.10 to i33, !dbg !161 ; [#uses=1 type=i33] [debug line = 44:21]
  br label %.preheader2, !dbg !161                ; [debug line = 44:21]

.preheader2:                                      ; preds = %13, %.preheader2.preheader
  %o_d = phi i31 [ %o_d.1, %13 ], [ 0, %.preheader2.preheader ] ; [#uses=3 type=i31]
  %o_d.cast = zext i31 %o_d to i32, !dbg !161     ; [#uses=3 type=i32] [debug line = 44:21]
  %tmp.11 = icmp slt i32 %o_d.cast, %od, !dbg !161 ; [#uses=1 type=i1] [debug line = 44:21]
  br i1 %tmp.11, label %.preheader1.preheader, label %14, !dbg !161 ; [debug line = 44:21]

.preheader1.preheader:                            ; preds = %.preheader2
  %tmp.17.cast = zext i31 %o_d to i33, !dbg !143  ; [#uses=1 type=i33] [debug line = 53:86]
  %tmp7 = add i33 %tmp.17.cast, %tmp.4.cast, !dbg !143 ; [#uses=1 type=i33] [debug line = 53:86]
  %tmp7.cast = sext i33 %tmp7 to i64, !dbg !143   ; [#uses=1 type=i64] [debug line = 53:86]
  %tmp.12 = add i64 %tmp.3, %tmp7.cast, !dbg !143 ; [#uses=1 type=i64] [debug line = 53:86]
  %mem.addr = getelementptr inbounds float* %mem, i64 %tmp.12, !dbg !143 ; [#uses=1 type=float*] [debug line = 53:86]
  %tmp8 = mul i32 %k, %id, !dbg !152              ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp9 = mul i32 %o_d.cast, %k, !dbg !152        ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.13 = mul i32 %tmp8, %tmp9, !dbg !152       ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.14 = sext i32 %tmp.13 to i64, !dbg !152    ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp = mul i32 %o_d.cast, %oy, !dbg !159        ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.15 = mul i32 %tmp, %ox, !dbg !159          ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.16 = sext i32 %tmp.15 to i64, !dbg !159    ; [#uses=1 type=i64] [debug line = 72:87]
...
.preheader1:                                      ; preds = %12, %.preheader1.preheader
  ...
  %o_y.cast = zext i31 %o_y to i32, !dbg !162     ; [#uses=3 type=i32] [debug line = 47:23]
  %tmp.17 = icmp slt i32 %o_y.cast, %oy, !dbg !162 ; [#uses=1 type=i1] [debug line = 47:23]
  br i1 %tmp.17, label %.preheader.preheader, label %13, !dbg !162 ; [debug line = 47:23]

.preheader.preheader:                             ; preds = %.preheader1
  %i_y = mul nsw i32 %o_y.cast, %s, !dbg !163     ; [#uses=2 type=i32] [debug line = 61:42]
  %tmp.18 = add nsw i32 %i_y, %k, !dbg !163       ; [#uses=1 type=i32] [debug line = 61:42]
  %tmp.19 = mul nsw i32 %o_y.cast, %ox, !dbg !159 ; [#uses=1 type=i32] [debug line = 72:87]
  %tmp.30.cast = sext i32 %tmp.19 to i34, !dbg !164 ; [#uses=1 type=i34] [debug line = 50:25]
  br label %.preheader, !dbg !164                 ; [debug line = 50:25]

.preheader:                                       ; preds = %11, %.preheader.preheader
  %o_x = phi i31 [ %o_x.1, %11 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i31]
  %o_x.cast = zext i31 %o_x to i32, !dbg !164     ; [#uses=2 type=i32] [debug line = 50:25]
  %tmp.20 = icmp slt i32 %o_x.cast, %ox, !dbg !164 ; [#uses=1 type=i1] [debug line = 50:25]
  br i1 %tmp.20, label %2, label %12, !dbg !164   ; [debug line = 50:25]
...
; <label>:2                                       ; preds = %.preheader
  ...
  %i_x = mul nsw i32 %o_x.cast, %s, !dbg !166     ; [#uses=2 type=i32] [debug line = 64:44]
  %tmp.21 = add nsw i32 %i_x, %k, !dbg !166       ; [#uses=1 type=i32] [debug line = 64:44]
  br label %3, !dbg !167                          ; [debug line = 58:27]

; <label>:3                                       ; preds = %10, %2
  %tmp.22 = phi float [ %output_element, %2 ], [ %tmp.48.lcssa, %10 ] ; [#uses=2 type=float]
  %i_d = phi i31 [ 0, %2 ], [ %i_d.1, %10 ]       ; [#uses=2 type=i31]
  %i_d.cast = zext i31 %i_d to i32, !dbg !167     ; [#uses=3 type=i32] [debug line = 58:27]
  %tmp.23 = icmp slt i32 %i_d.cast, %id, !dbg !167 ; [#uses=1 type=i1] [debug line = 58:27]
  br i1 %tmp.23, label %4, label %11, !dbg !167   ; [debug line = 58:27]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i32 %i_y}, i64 0, metadata !168), !dbg !163 ; [debug line = 61:42] [debug variable = i_y]
  %tmp10 = mul i32 %i_d.cast, %ix, !dbg !152      ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.24 = mul i32 %tmp10, %iy, !dbg !152        ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.37.cast = sext i32 %tmp.24 to i33, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp11 = mul i32 %i_d.cast, %k, !dbg !152       ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.25 = mul i32 %tmp11, %k, !dbg !152         ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.40.cast = sext i32 %tmp.25 to i34, !dbg !163 ; [#uses=1 type=i34] [debug line = 61:42]
  br label %5, !dbg !163                          ; [debug line = 61:42]

; <label>:5                                       ; preds = %9, %4
  %tmp.33 = phi float [ %tmp.22, %4 ], [ %tmp.54.lcssa, %9 ] ; [#uses=2 type=float]
  %i_y1 = phi i32 [ %i_y, %4 ], [ %i_y.1, %9 ]    ; [#uses=3 type=i32]
  %iiy = phi i32 [ 0, %4 ], [ %iiy.1, %9 ]        ; [#uses=2 type=i32]
  %tmp.34 = icmp slt i32 %i_y1, %tmp.18, !dbg !163 ; [#uses=1 type=i1] [debug line = 61:42]
  br i1 %tmp.34, label %6, label %10, !dbg !163   ; [debug line = 61:42]

; <label>:6                                       ; preds = %5
  call void @llvm.dbg.value(metadata !{i32 %i_x}, i64 0, metadata !169), !dbg !166 ; [debug line = 64:44] [debug variable = i_x]
  %tmp.35 = mul nsw i32 %i_y1, %ix, !dbg !152     ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.51.cast = sext i32 %tmp.35 to i33, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp.36 = mul nsw i32 %iiy, %k, !dbg !152       ; [#uses=1 type=i32] [debug line = 66:17]
  %tmp.53.cast = sext i32 %tmp.36 to i33, !dbg !166 ; [#uses=1 type=i33] [debug line = 64:44]
  br label %7, !dbg !166                          ; [debug line = 64:44]

; <label>:7                                       ; preds = %8, %6
  %tmp.37 = phi float [ %tmp.33, %6 ], [ %output_element.1, %8 ] ; [#uses=2 type=float]
  %i_x1 = phi i32 [ %i_x, %6 ], [ %i_x.1, %8 ]    ; [#uses=3 type=i32]
  %iix = phi i32 [ 0, %6 ], [ %iix.1, %8 ]        ; [#uses=2 type=i32]
  %tmp.38 = icmp slt i32 %i_x1, %tmp.21, !dbg !166 ; [#uses=1 type=i1] [debug line = 64:44]
  br i1 %tmp.38, label %8, label %9, !dbg !166    ; [debug line = 64:44]

; <label>:8                                       ; preds = %7
  %tmp.56.cast = sext i32 %i_x1 to i33, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp14 = add i33 %tmp.4.cast, %tmp.5.cast, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp14.cast = sext i33 %tmp14 to i64, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp13 = add i64 %tmp.3, %tmp14.cast, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp16 = add i33 %tmp.37.cast, %tmp.11.cast, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp16.cast = sext i33 %tmp16 to i34, !dbg !152 ; [#uses=1 type=i34] [debug line = 66:17]
  %tmp17 = add i33 %tmp.56.cast, %tmp.51.cast, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp17.cast = sext i33 %tmp17 to i34, !dbg !152 ; [#uses=1 type=i34] [debug line = 66:17]
  %tmp15 = add i34 %tmp16.cast, %tmp17.cast, !dbg !152 ; [#uses=1 type=i34] [debug line = 66:17]
  %tmp15.cast = sext i34 %tmp15 to i64, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp.39 = add i64 %tmp13, %tmp15.cast, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %mem.addr.2 = getelementptr inbounds float* %mem, i64 %tmp.39, !dbg !152 ; [#uses=1 type=float*] [debug line = 66:17]
  %mem.load = load float* %mem.addr.2, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 66:17]
  %tmp.63.cast = sext i32 %iix to i33, !dbg !152  ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp18 = add i64 %tmp.14, %tmp.3, !dbg !152     ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp20 = add i33 %tmp.63.cast, %tmp.53.cast, !dbg !152 ; [#uses=1 type=i33] [debug line = 66:17]
  %tmp20.cast = sext i33 %tmp20 to i34, !dbg !152 ; [#uses=1 type=i34] [debug line = 66:17]
  %tmp19 = add i34 %tmp.40.cast, %tmp20.cast, !dbg !152 ; [#uses=1 type=i34] [debug line = 66:17]
  %tmp19.cast = sext i34 %tmp19 to i64, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %tmp.40 = add i64 %tmp18, %tmp19.cast, !dbg !152 ; [#uses=1 type=i64] [debug line = 66:17]
  %mem.addr.3 = getelementptr inbounds float* %mem, i64 %tmp.40, !dbg !152 ; [#uses=1 type=float*] [debug line = 66:17]
  %mem.load.1 = load float* %mem.addr.3, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 66:17]
  %tmp.41 = fmul float %mem.load, %mem.load.1, !dbg !152 ; [#uses=1 type=float] [debug line = 66:17]
  %output_element.1 = fadd float %tmp.37, %tmp.41, !dbg !152 ; [#uses=1 type=float] [debug line = 66:17]
...
; <label>:9                                       ; preds = %7
  %tmp.54.lcssa = phi float [ %tmp.37, %7 ]       ; [#uses=1 type=float]
...
; <label>:10                                      ; preds = %5
  %tmp.48.lcssa = phi float [ %tmp.33, %5 ]       ; [#uses=1 type=float]
  %i_d.1 = add i31 %i_d, 1, !dbg !174             ; [#uses=1 type=i31] [debug line = 58:39]
  call void @llvm.dbg.value(metadata !{i31 %i_d.1}, i64 0, metadata !175), !dbg !174 ; [debug line = 58:39] [debug variable = i_d]
  br label %3, !dbg !174                          ; [debug line = 58:39]

; <label>:11                                      ; preds = %3
  %tmp.33.lcssa = phi float [ %tmp.22, %3 ]       ; [#uses=3 type=float]
  %tmp.33_to_int = bitcast float %tmp.33.lcssa to i32 ; [#uses=2 type=i32]
  %tmp.26 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %tmp.33_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp.27 = trunc i32 %tmp.33_to_int to i23       ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp.26, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp.27, 0                ; [#uses=1 type=i1]
  %tmp.28 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp.29 = fcmp ogt float %tmp.33.lcssa, 0.000000e+00, !dbg !176 ; [#uses=1 type=i1] [debug line = 215:7@72:87]
  %tmp.30 = and i1 %tmp.28, %tmp.29, !dbg !176    ; [#uses=1 type=i1] [debug line = 215:7@72:87]
  %tmp.31 = select i1 %tmp.30, float %tmp.33.lcssa, float 0.000000e+00, !dbg !159 ; [#uses=1 type=float] [debug line = 72:87]
  %tmp.43.cast = zext i31 %o_x to i33, !dbg !159  ; [#uses=1 type=i33] [debug line = 72:87]
  %tmp21 = add i64 %tmp.16, %tmp.7, !dbg !159     ; [#uses=1 type=i64] [debug line = 72:87]
  %tmp23 = add i33 %tmp.43.cast, %tmp.15.cast, !dbg !159 ; [#uses=1 type=i33] [debug line = 72:87]
  %tmp23.cast = sext i33 %tmp23 to i34, !dbg !159 ; [#uses=1 type=i34] [debug line = 72:87]
  %tmp22 = add i34 %tmp.30.cast, %tmp23.cast, !dbg !159 ; [#uses=1 type=i34] [debug line = 72:87]
  %tmp22.cast = sext i34 %tmp22 to i64, !dbg !159 ; [#uses=1 type=i64] [debug line = 72:87]
  %tmp.32 = add i64 %tmp21, %tmp22.cast, !dbg !159 ; [#uses=1 type=i64] [debug line = 72:87]
  %mem.addr.1 = getelementptr inbounds float* %mem, i64 %tmp.32, !dbg !159 ; [#uses=1 type=float*] [debug line = 72:87]
  store float %tmp.31, float* %mem.addr.1, align 4, !dbg !159 ; [debug line = 72:87]
  %o_x.1 = add i31 %o_x, 1, !dbg !179             ; [#uses=1 type=i31] [debug line = 50:37]
  call void @llvm.dbg.value(metadata !{i31 %o_x.1}, i64 0, metadata !180), !dbg !179 ; [debug line = 50:37] [debug variable = o_x]
  br label %.preheader, !dbg !179                 ; [debug line = 50:37]

; <label>:12                                      ; preds = %.preheader
  %o_y.1 = add i31 %o_y, 1, !dbg !181             ; [#uses=1 type=i31] [debug line = 47:35]
  call void @llvm.dbg.value(metadata !{i31 %o_y.1}, i64 0, metadata !182), !dbg !181 ; [debug line = 47:35] [debug variable = o_y]
  br label %.preheader1, !dbg !181                ; [debug line = 47:35]

; <label>:13                                      ; preds = %.preheader1
  %o_d.1 = add i31 %o_d, 1, !dbg !183             ; [#uses=1 type=i31] [debug line = 44:33]
  call void @llvm.dbg.value(metadata !{i31 %o_d.1}, i64 0, metadata !184), !dbg !183 ; [debug line = 44:33] [debug variable = o_d]
  br label %.preheader2, !dbg !183                ; [debug line = 44:33]

; <label>:14                                      ; preds = %.preheader2
  %b_.1 = add i31 %b_, 1, !dbg !185               ; [#uses=1 type=i31] [debug line = 41:25]
  call void @llvm.dbg.value(metadata !{i31 %b_.1}, i64 0, metadata !186), !dbg !185 ; [debug line = 41:25] [debug variable = b_]
...
!178 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2018.1/lnx64/tools/gcc/lib/gcc/x86_64-unknown-linux-gnu/4.6.3/../../../../include/c++/4.6.3/bits/stl_algobase.h", metadata !"/home/tarafdar/workDir/galapagos", null} ; [ DW_TAG_file_type ]
