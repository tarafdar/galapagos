...
const bool reverseEndian64::ap_const_boolean_1 = true;
...
void reverseEndian64::thread_stream_in_TREADY() {
    stream_in_TREADY = stream_in_V_tkeep_V_0_state.read()[1];
}
...
void reverseEndian64::thread_stream_in_V_data_V_0_ack_out() {
    if ((!(esl_seteq<1,1,1>(stream_out_V_data_V_1_ack_in.read(), ap_const_logic_0) || esl_seteq<1,1,1>(stream_in_V_data_V_0_vld_out.read(), ap_const_logic_0)) && 
...
void reverseEndian64::thread_stream_in_V_tkeep_V_0_ack_in() {
    stream_in_V_tkeep_V_0_ack_in = stream_in_V_tkeep_V_0_state.read()[1];
}
...
void reverseEndian64::thread_stream_in_V_tkeep_V_0_vld_out() {
    stream_in_V_tkeep_V_0_vld_out = stream_in_V_tkeep_V_0_state.read()[0];
}
...
void reverseEndian64::thread_stream_out_TVALID() {
    stream_out_TVALID = stream_out_V_tkeep_V_1_state.read()[0];
}
...
void reverseEndian64::thread_stream_out_V_tkeep_V_1_ack_in() {
    stream_out_V_tkeep_V_1_ack_in = stream_out_V_tkeep_V_1_state.read()[1];
}
...
void reverseEndian64::thread_stream_out_V_tkeep_V_1_vld_out() {
    stream_out_V_tkeep_V_1_vld_out = stream_out_V_tkeep_V_1_state.read()[0];
}
...
void reverseEndian64::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((!(esl_seteq<1,1,1>(stream_out_V_data_V_1_ack_in.read(), ap_const_logic_0) || esl_seteq<1,1,1>(stream_in_V_data_V_0_vld_out.read(), ap_const_logic_0)) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
