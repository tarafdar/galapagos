...
set Version     "1.05"
set DisplayName "UDP App Multiplexer for DHCP"
set Revision    "1703262309"
set Description "This module enables the connection of both the DHCP server and an additional application to the UDP offload engine, granted the DHCP server uses the standard ports."
set Device      "kintexu"
...
set Interfaces {
    ...
    portOpenReplyOutApp {
        type "axi4stream"
        mode "master"
        port_prefix "portOpenReplyOutApp"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    portOpenReplyOutDhcp {
        type "axi4stream"
        mode "master"
        port_prefix "portOpenReplyOutDhcp"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    requestPortOpenInApp {
        type "axi4stream"
        mode "slave"
        port_prefix "requestPortOpenInApp"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    requestPortOpenInDhcp {
        type "axi4stream"
        mode "slave"
        port_prefix "requestPortOpenInDhcp"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    requestPortOpenOut {
        type "axi4stream"
        mode "master"
        port_prefix "requestPortOpenOut"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    aclk {
        type "clock"
        buses "portOpenReplyIn portOpenReplyOutApp portOpenReplyOutDhcp requestPortOpenInApp requestPortOpenInDhcp requestPortOpenOut rxDataIn rxDataOutApp rxDataOutDhcp rxMetadataIn rxMetadataOutApp rxMetadataOutDhcp txDataInApp txDataInDhcp txDataOut txLengthInApp txLengthInDhcp txLengthOut txMetadataInApp txMetadataInDhcp txMetadataOut"
    }
    aresetn {
        type "reset"
    }
