...
set Library     "hls"
set IPName      "min_sum_dec"
set Version     "1.0"
set DisplayName "Min_sum_dec"
set Revision    "1706021933"
...
set Interfaces {
    ap_clk {
        ...
        buses "m_axi_noisy_input m_axi_soft_dec_out m_axi_hard_dec_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_noisy_input {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_noisy_input"
        data_width "32"
        param_prefix "C_M_AXI_NOISY_INPUT"
    ...
    m_axi_soft_dec_out {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_soft_dec_out"
        data_width "32"
        param_prefix "C_M_AXI_SOFT_DEC_OUT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_hard_dec_out {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_hard_dec_out"
        data_width "32"
        param_prefix "C_M_AXI_HARD_DEC_OUT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 13884 II x}
...
set enable_xo_gen 0
set kernel_files {/home/eskand38/Desktop/project_7_1/axi/min_sum_dec/min_sum_dec.cpp}
if {$enable_xo_gen} {
