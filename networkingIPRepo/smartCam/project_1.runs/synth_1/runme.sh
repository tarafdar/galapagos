...
HD_PWD='/home/nariman/Desktop/HLS_Project_tests/smartCam_ip_package/test0/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SmartCamCtl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SmartCamCtl_wrapper.tcl
