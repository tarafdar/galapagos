...
HD_PWD='/home/nariman/Desktop/HLS_Project_tests/smartCam_ip_package/test0/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SmartCamCtl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SmartCamCtl_wrapper.tcl -notrace
