...
set src_path_root $galapagos_path/hwMiddleware/hls/network_bridge_ethernet
...
set_part ${part_name}
#csynth path
add_files $src_path_root/src/ethernet_bridge.cpp -cflags "-I $src_path_root/include -I $galapagos_path/include"
