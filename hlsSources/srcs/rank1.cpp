...
void sender(stream<ap_uint<128> > * stream_out,
		stream<ap_uint<128> > * stream_in,
		int & state_out){
...
#pragma HLS INTERFACE ap_none port=state_out
	...
	MPI_Recv(stream_out,stream_in,to_send_array,10,MPI_INT,2,-1,0,state_out);

	MPI_Send(stream_out,stream_in,to_send_array,10,MPI_INT,0,-1,0);
}
