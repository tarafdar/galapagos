...
set_property -dict [list CONFIG.NUM_SI ${num_local_ranks} CONFIG.NUM_MI {1} CONFIG.DECODER_REG {1} CONFIG.HAS_TLAST {1} CONFIG.ARB_ON_MAX_XFERS {0} CONFIG.ARB_ON_TLAST {1} CONFIG.M00_AXIS_HIGHTDEST {0xffffffff}] [get_bd_cells applicationRegion/output_switch]
