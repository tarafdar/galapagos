...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_ports S_AXIS] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_ports S_AXI_MEM_0] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_ports S_AXI_MEM_1] [get_bd_intf_pins smartconnect_0/M02_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_ports ARESETN] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00002000 [get_bd_addr_spaces S_AXI_CONTROL] [get_bd_addr_segs axi_fifo_mm_s_0/S_AXI/Mem0] SEG_axi_fifo_mm_s_0_Mem0
