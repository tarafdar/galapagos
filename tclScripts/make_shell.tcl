...
set project_path ${::env(GALAPAGOS_PATH)}/projects/${::env(GALAPAGOS_BOARD_NAME)}/${::env(GALAPAGOS_VIVADO_VERSION)}/$project_name
set shell_path ${::env(GALAPAGOS_PATH)}/shells/${::env(GALAPAGOS_BOARD_NAME)}

# Create project
create_project $project_name $project_path -part ${::env(GALAPAGOS_PART)} -force
...
set_property ip_repo_paths [list \
  hlsIP_${::env(GALAPAGOS_BOARD_NAME)} \
  ${::env(GALAPAGOS_PATH)}/shells/shell_ips \
...
if {! [catch {glob shells/${::env(GALAPAGOS_BOARD_NAME)}/constraints/*.xdc} yikes] } {
