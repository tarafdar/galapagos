...
set src_path_root $galapagos_path/hwMiddleware/hls/router
...
set_part ${part_name}
#csynth path
add_files $src_path_root/src/router.cpp -cflags "-I $src_path_root/include -I $galapagos_path/include -D NETWORK_HEADER_LENGTH=$width"
