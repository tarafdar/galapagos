...
create_bd_cell -type ip -vlnv xilinx.com:hls:raw_bridge:1.0 network/network_bridge_inst
...
connect_bd_intf_net [get_bd_intf_ports S_AXIS] [get_bd_intf_pins network/network_bridge_inst/from_raw_V]
connect_bd_intf_net [get_bd_intf_ports M_AXIS] [get_bd_intf_pins network/network_bridge_inst/to_raw_V]
