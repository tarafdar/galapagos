; ModuleID = '/home/tarafdar/thesis/gitStuff/hlsIP_8k5/fireWall64_2/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"class.hls::stream.406.440" = type { %struct.ap_axis.405.439 }
%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }
%struct.ap_int.0.398.432 = type { %struct.ap_int_base.1.397.431 }
%struct.ap_int_base.1.397.431 = type { %"class.std::locale::id.374.408" }
%"class.std::locale::id.374.408" = type { i64 }
%struct.ap_uint.401.435 = type { %struct.ap_int_base.3.400.434 }
%struct.ap_int_base.3.400.434 = type { %struct.ssdm_int.4.399.433 }
%struct.ssdm_int.4.399.433 = type { i8 }
%struct.ap_uint.5.404.438 = type { %struct.ap_int_base.6.403.437 }
%struct.ap_int_base.6.403.437 = type { %struct.ssdm_int.7.402.436 }
%struct.ssdm_int.7.402.436 = type { i1 }
...
; [#uses=0]
define void @fireWall64_2(%"class.hls::stream.406.440"* %stream_in, %"class.hls::stream.406.440"* %stream_out, %"class.hls::stream.406.440"* %stream_garbage, %struct.ap_uint.5.404.438* %match_in) noreturn nounwind uwtable {
  call void (...)* @_ssdm_op_SpecTopModule([13 x i8]* @fireWall64_2.str) nounwind
  %tmp = alloca %struct.ap_axis.405.439, align 8  ; [#uses=4 type=%struct.ap_axis.405.439*]
  %tmp.1 = alloca %struct.ap_axis.405.439, align 8 ; [#uses=4 type=%struct.ap_axis.405.439*]
  %tmp.2 = alloca %struct.ap_axis.405.439, align 8 ; [#uses=4 type=%struct.ap_axis.405.439*]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.406.440"* %stream_in}, metadata !4347), !dbg !4348 ; [debug line = 18:25] [debug variable = stream_in]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.406.440"* %stream_out}, metadata !4349), !dbg !4350 ; [debug line = 19:25] [debug variable = stream_out]
  call void @llvm.dbg.declare(metadata !{%"class.hls::stream.406.440"* %stream_garbage}, metadata !4351), !dbg !4352 ; [debug line = 20:25] [debug variable = stream_garbage]
  call void @llvm.dbg.value(metadata !{%struct.ap_uint.5.404.438* %match_in}, i64 0, metadata !4353), !dbg !4354 ; [debug line = 21:16] [debug variable = match_in]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_uint.5.404.438* %match_in, i8* getelementptr inbounds ([7 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4355 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([13 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4355 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.406.440"* %stream_out, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4355 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.406.440"* %stream_garbage, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4355 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%"class.hls::stream.406.440"* %stream_in, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !4355 ; [debug line = 23:1]
  br label %1

; <label>:1                                       ; preds = %0
  %stream_in.addr = getelementptr inbounds %"class.hls::stream.406.440"* %stream_in, i64 0, i32 0, !dbg !4357 ; [#uses=1 type=%struct.ap_axis.405.439*] [debug line = 131:9@36:18]
  %match_in.addr = getelementptr inbounds %struct.ap_uint.5.404.438* %match_in, i64 0, i32 0, i32 0, i32 0, !dbg !4361 ; [#uses=1 type=i1*] [debug line = 1653:70@37:6]
  %tmp.i1.addr = getelementptr inbounds %struct.ap_axis.405.439* %tmp, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !4364 ; [#uses=1 type=i64*] [debug line = 145:31@38:4]
  %tmp.i1.addr.1 = getelementptr inbounds %struct.ap_axis.405.439* %tmp, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !4364 ; [#uses=1 type=i8*] [debug line = 145:31@38:4]
  %tmp.i1.addr.2 = getelementptr inbounds %struct.ap_axis.405.439* %tmp, i64 0, i32 2, i32 0, i32 0, i32 0, !dbg !4364 ; [#uses=1 type=i1*] [debug line = 145:31@38:4]
  %stream_out.addr = getelementptr inbounds %"class.hls::stream.406.440"* %stream_out, i64 0, i32 0, !dbg !4367 ; [#uses=1 type=%struct.ap_axis.405.439*] [debug line = 146:9@38:4]
  %tmp.i.addr = getelementptr inbounds %struct.ap_axis.405.439* %tmp.1, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !4368 ; [#uses=1 type=i64*] [debug line = 145:31@40:4]
  %tmp.i.addr.1 = getelementptr inbounds %struct.ap_axis.405.439* %tmp.1, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !4368 ; [#uses=1 type=i8*] [debug line = 145:31@40:4]
  %tmp.i.addr.2 = getelementptr inbounds %struct.ap_axis.405.439* %tmp.1, i64 0, i32 2, i32 0, i32 0, i32 0, !dbg !4368 ; [#uses=1 type=i1*] [debug line = 145:31@40:4]
  %stream_garbage.addr = getelementptr inbounds %"class.hls::stream.406.440"* %stream_garbage, i64 0, i32 0, !dbg !4370 ; [#uses=1 type=%struct.ap_axis.405.439*] [debug line = 146:9@40:4]
  br label %2, !dbg !4371                         ; [debug line = 35:2]

; <label>:2                                       ; preds = %5, %1
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.406.440"* %stream_in}, i64 0, metadata !4372), !dbg !4374 ; [debug line = 129:56@36:18] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.405.439* %tmp.2}, metadata !4375) nounwind, !dbg !4376 ; [debug line = 130:22@36:18] [debug variable = tmp]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.405.439* %tmp.2}, i64 0, metadata !4377), !dbg !4380 ; [debug line = 8:8@130:25@36:18] [debug variable = this]
  call void @llvm.dbg.value(metadata !{%struct.ap_axis.405.439* %tmp.2}, i64 0, metadata !4381), !dbg !4382 ; [debug line = 8:8@8:8@130:25@36:18] [debug variable = this]
  call void @"_ssdm_op_IfRead.Stream.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P"(%struct.ap_axis.405.439* %stream_in.addr, %struct.ap_axis.405.439* %tmp.2) nounwind, !dbg !4357 ; [debug line = 131:9@36:18]
  %this.assign.addr = getelementptr inbounds %struct.ap_axis.405.439* %tmp.2, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !4383 ; [#uses=1 type=i64*] [debug line = 172:10@8:8@36:18]
  %this.assign.load = load i64* %this.assign.addr, align 8, !dbg !4383 ; [#uses=5 type=i64] [debug line = 172:10@8:8@36:18]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %this.assign.load) nounwind
  %this.assign.addr.1 = getelementptr inbounds %struct.ap_axis.405.439* %tmp.2, i64 0, i32 1, i32 0, i32 0, i32 0, !dbg !4387 ; [#uses=1 type=i8*] [debug line = 277:10@8:8@36:18]
  %this.assign.load.1 = load i8* %this.assign.addr.1, align 8, !dbg !4387 ; [#uses=5 type=i8] [debug line = 277:10@8:8@36:18]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %this.assign.load.1) nounwind
  %this.assign.addr.2 = getelementptr inbounds %struct.ap_axis.405.439* %tmp.2, i64 0, i32 2, i32 0, i32 0, i32 0, !dbg !4389 ; [#uses=1 type=i1*] [debug line = 277:10@8:8@36:18]
  %this.assign.load.2 = load i1* %this.assign.addr.2, align 1, !dbg !4389 ; [#uses=5 type=i1] [debug line = 277:10@8:8@36:18]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.2) nounwind
  %match_in.load = load i1* %match_in.addr, align 1, !dbg !4361 ; [#uses=2 type=i1] [debug line = 1653:70@37:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %match_in.load) nounwind
  br i1 %match_in.load, label %3, label %4, !dbg !4363 ; [debug line = 37:6]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.406.440"* %stream_out}, i64 0, metadata !4391), !dbg !4392 ; [debug line = 144:48@38:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.405.439* %tmp}, metadata !4393) nounwind, !dbg !4394 ; [debug line = 145:22@38:4] [debug variable = tmp]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %this.assign.load) nounwind
  store i64 %this.assign.load, i64* %tmp.i1.addr, align 8, !dbg !4364 ; [debug line = 145:31@38:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %this.assign.load.1) nounwind
  store i8 %this.assign.load.1, i8* %tmp.i1.addr.1, align 8, !dbg !4364 ; [debug line = 145:31@38:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.2) nounwind
  store i1 %this.assign.load.2, i1* %tmp.i1.addr.2, align 1, !dbg !4364 ; [debug line = 145:31@38:4]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P"(%struct.ap_axis.405.439* %stream_out.addr, %struct.ap_axis.405.439* %tmp) nounwind, !dbg !4367 ; [debug line = 146:9@38:4]
  br label %5, !dbg !4366                         ; [debug line = 38:4]

; <label>:4                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{%"class.hls::stream.406.440"* %stream_garbage}, i64 0, metadata !4391), !dbg !4395 ; [debug line = 144:48@40:4] [debug variable = this]
  call void @llvm.dbg.declare(metadata !{%struct.ap_axis.405.439* %tmp.1}, metadata !4393) nounwind, !dbg !4396 ; [debug line = 145:22@40:4] [debug variable = tmp]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i64 %this.assign.load) nounwind
  store i64 %this.assign.load, i64* %tmp.i.addr, align 8, !dbg !4368 ; [debug line = 145:31@40:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i8 %this.assign.load.1) nounwind
  store i8 %this.assign.load.1, i8* %tmp.i.addr.1, align 8, !dbg !4368 ; [debug line = 145:31@40:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %this.assign.load.2) nounwind
  store i1 %this.assign.load.2, i1* %tmp.i.addr.2, align 1, !dbg !4368 ; [debug line = 145:31@40:4]
  call void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P"(%struct.ap_axis.405.439* %stream_garbage.addr, %struct.ap_axis.405.439* %tmp.1) nounwind, !dbg !4370 ; [debug line = 146:9@40:4]
  br label %5

; <label>:5                                       ; preds = %4, %3
  br label %2, !dbg !4397                         ; [debug line = 42:2]
}
...
; [#uses=2]
declare void @"_ssdm_op_IfWrite.Stream.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P"(%struct.ap_axis.405.439*, %struct.ap_axis.405.439*)

; [#uses=1]
declare void @"_ssdm_op_IfRead.Stream.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P.%struct.ap_axis.405.439 = type { %struct.ap_int.0.398.432, %struct.ap_uint.401.435, %struct.ap_uint.5.404.438 }P"(%struct.ap_axis.405.439*, %struct.ap_axis.405.439*)
...
!4314 = metadata !{void (%"class.hls::stream.406.440"*, %"class.hls::stream.406.440"*, %"class.hls::stream.406.440"*, %struct.ap_uint.5.404.438*)* @fireWall64_2, metadata !4315, metadata !4316, metadata !4317, metadata !4318, metadata !4319, metadata !4320}
...
!4347 = metadata !{i32 786689, metadata !901, metadata !"stream_in", metadata !902, i32 16777234, metadata !2223, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4348 = metadata !{i32 18, i32 25, metadata !901, null}
!4349 = metadata !{i32 786689, metadata !901, metadata !"stream_out", metadata !902, i32 33554451, metadata !2223, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4350 = metadata !{i32 19, i32 25, metadata !901, null}
!4351 = metadata !{i32 786689, metadata !901, metadata !"stream_garbage", metadata !902, i32 50331668, metadata !2223, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4352 = metadata !{i32 20, i32 25, metadata !901, null}
!4353 = metadata !{i32 786689, metadata !901, metadata !"match_in", metadata !902, i32 67108885, metadata !2251, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4354 = metadata !{i32 21, i32 16, metadata !901, null}
!4355 = metadata !{i32 23, i32 1, metadata !4356, null}
!4356 = metadata !{i32 786443, metadata !901, i32 22, i32 2, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!4357 = metadata !{i32 131, i32 9, metadata !4358, metadata !4359}
!4358 = metadata !{i32 786443, metadata !2571, i32 129, i32 63, metadata !907, i32 4} ; [ DW_TAG_lexical_block ]
!4359 = metadata !{i32 36, i32 18, metadata !4360, null}
!4360 = metadata !{i32 786443, metadata !4356, i32 35, i32 14, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!4361 = metadata !{i32 1653, i32 70, metadata !4362, metadata !4363}
!4362 = metadata !{i32 786443, metadata !2570, i32 1653, i32 68, metadata !891, i32 3} ; [ DW_TAG_lexical_block ]
!4363 = metadata !{i32 37, i32 6, metadata !4360, null}
!4364 = metadata !{i32 145, i32 31, metadata !4365, metadata !4366}
!4365 = metadata !{i32 786443, metadata !2569, i32 144, i32 79, metadata !907, i32 2} ; [ DW_TAG_lexical_block ]
!4366 = metadata !{i32 38, i32 4, metadata !4360, null}
!4367 = metadata !{i32 146, i32 9, metadata !4365, metadata !4366}
!4368 = metadata !{i32 145, i32 31, metadata !4365, metadata !4369}
!4369 = metadata !{i32 40, i32 4, metadata !4360, null}
!4370 = metadata !{i32 146, i32 9, metadata !4365, metadata !4369}
!4371 = metadata !{i32 35, i32 2, metadata !4356, null}
!4372 = metadata !{i32 786689, metadata !2571, metadata !"this", metadata !907, i32 16777345, metadata !4373, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4373 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !905} ; [ DW_TAG_pointer_type ]
!4374 = metadata !{i32 129, i32 56, metadata !2571, metadata !4359}
!4375 = metadata !{i32 786688, metadata !4358, metadata !"tmp", metadata !907, i32 130, metadata !2205, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4376 = metadata !{i32 130, i32 22, metadata !4358, metadata !4359}
!4377 = metadata !{i32 786689, metadata !2584, metadata !"this", metadata !902, i32 16777224, metadata !4378, i32 64, metadata !4379} ; [ DW_TAG_arg_variable ]
!4378 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !910} ; [ DW_TAG_pointer_type ]
!4379 = metadata !{i32 130, i32 25, metadata !4358, metadata !4359}
!4380 = metadata !{i32 8, i32 8, metadata !2584, metadata !4379}
!4381 = metadata !{i32 786689, metadata !2585, metadata !"this", metadata !902, i32 16777224, metadata !4378, i32 64, metadata !4380} ; [ DW_TAG_arg_variable ]
!4382 = metadata !{i32 8, i32 8, metadata !2585, metadata !4380}
!4383 = metadata !{i32 172, i32 10, metadata !4384, metadata !4385}
!4384 = metadata !{i32 786443, metadata !2583, i32 171, i32 90, metadata !914, i32 14} ; [ DW_TAG_lexical_block ]
!4385 = metadata !{i32 8, i32 8, metadata !4386, metadata !4359}
!4386 = metadata !{i32 786443, metadata !2580, i32 8, i32 8, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!4387 = metadata !{i32 277, i32 10, metadata !4388, metadata !4385}
!4388 = metadata !{i32 786443, metadata !2582, i32 276, i32 92, metadata !914, i32 13} ; [ DW_TAG_lexical_block ]
!4389 = metadata !{i32 277, i32 10, metadata !4390, metadata !4385}
!4390 = metadata !{i32 786443, metadata !2581, i32 276, i32 92, metadata !914, i32 12} ; [ DW_TAG_lexical_block ]
!4391 = metadata !{i32 786689, metadata !2569, metadata !"this", metadata !907, i32 16777360, metadata !4373, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!4392 = metadata !{i32 144, i32 48, metadata !2569, metadata !4366}
!4393 = metadata !{i32 786688, metadata !4365, metadata !"tmp", metadata !907, i32 145, metadata !910, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4394 = metadata !{i32 145, i32 22, metadata !4365, metadata !4366}
!4395 = metadata !{i32 144, i32 48, metadata !2569, metadata !4369}
!4396 = metadata !{i32 145, i32 22, metadata !4365, metadata !4369}
!4397 = metadata !{i32 42, i32 2, metadata !4360, null}
