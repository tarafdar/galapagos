...
architecture behav of reverseEndian64 is 
    ...
    "reverseEndian64,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=320,HLS_SYN_LUT=179}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = stream_in_V_tkeep_V_0_ack_out) and (ap_const_logic_1 = stream_in_V_tkeep_V_0_vld_out))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_logic_1 = stream_in_V_tkeep_V_0_ack_in))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_const_logic_0 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_logic_1 = stream_in_V_tkeep_V_0_ack_out) and (ap_const_lv2_3 = stream_in_V_tkeep_V_0_state)) or ((ap_const_logic_0 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_lv2_2 = stream_in_V_tkeep_V_0_state)))) then 
                    stream_in_V_tkeep_V_0_state <= ap_const_lv2_2;
                elsif ((((ap_const_logic_1 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_logic_0 = stream_in_V_tkeep_V_0_ack_out) and (ap_const_lv2_3 = stream_in_V_tkeep_V_0_state)) or ((ap_const_logic_0 = stream_in_V_tkeep_V_0_ack_out) and (ap_const_lv2_1 = stream_in_V_tkeep_V_0_state)))) then 
                    stream_in_V_tkeep_V_0_state <= ap_const_lv2_1;
                elsif ((((ap_const_logic_1 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_lv2_2 = stream_in_V_tkeep_V_0_state)) or ((ap_const_logic_1 = stream_in_V_tkeep_V_0_ack_out) and (ap_const_lv2_1 = stream_in_V_tkeep_V_0_state)) or ((ap_const_lv2_3 = stream_in_V_tkeep_V_0_state) and not(((ap_const_logic_1 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_logic_0 = stream_in_V_tkeep_V_0_ack_out))) and not(((ap_const_logic_0 = stream_in_V_tkeep_V_0_vld_in) and (ap_const_logic_1 = stream_in_V_tkeep_V_0_ack_out)))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = stream_out_V_tkeep_V_1_ack_out) and (ap_const_logic_1 = stream_out_V_tkeep_V_1_vld_out))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_logic_1 = stream_out_V_tkeep_V_1_ack_in))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_const_logic_0 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_logic_1 = stream_out_V_tkeep_V_1_ack_out) and (ap_const_lv2_3 = stream_out_V_tkeep_V_1_state)) or ((ap_const_logic_0 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_lv2_2 = stream_out_V_tkeep_V_1_state)))) then 
                    stream_out_V_tkeep_V_1_state <= ap_const_lv2_2;
                elsif ((((ap_const_logic_1 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_logic_0 = stream_out_V_tkeep_V_1_ack_out) and (ap_const_lv2_3 = stream_out_V_tkeep_V_1_state)) or ((ap_const_logic_0 = stream_out_V_tkeep_V_1_ack_out) and (ap_const_lv2_1 = stream_out_V_tkeep_V_1_state)))) then 
                    stream_out_V_tkeep_V_1_state <= ap_const_lv2_1;
                elsif ((((ap_const_logic_1 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_lv2_2 = stream_out_V_tkeep_V_1_state)) or ((ap_const_logic_1 = stream_out_V_tkeep_V_1_ack_out) and (ap_const_lv2_1 = stream_out_V_tkeep_V_1_state)) or ((ap_const_lv2_3 = stream_out_V_tkeep_V_1_state) and not(((ap_const_logic_1 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_logic_0 = stream_out_V_tkeep_V_1_ack_out))) and not(((ap_const_logic_0 = stream_out_V_tkeep_V_1_vld_in) and (ap_const_logic_1 = stream_out_V_tkeep_V_1_ack_out)))))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = stream_in_V_tkeep_V_0_load_A)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = stream_in_V_tkeep_V_0_load_B)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = stream_out_V_tkeep_V_1_load_A)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = stream_out_V_tkeep_V_1_load_B)) then
                stream_out_V_tkeep_V_1_payload_B <= stream_in_V_tkeep_V_0_data_out;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (stream_in_V_data_V_0_vld_out, stream_out_V_data_V_1_ack_in, ap_CS_fsm)
    begin
        case ap_CS_fsm is
    ...
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state3) and not(((stream_in_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = stream_out_V_data_V_1_ack_in))))) then 
    ...
    begin
        if ((ap_const_logic_1 = stream_in_V_tkeep_V_0_sel)) then 
    ...
    stream_in_V_tkeep_V_0_load_B <= (stream_in_V_tkeep_V_0_sel_wr and stream_in_V_tkeep_V_0_state_cmp_full);
    ...
    begin
        if ((ap_const_logic_1 = stream_out_V_tkeep_V_1_sel)) then 
    ...
    stream_out_V_tkeep_V_1_load_B <= (stream_out_V_tkeep_V_1_sel_wr and stream_out_V_tkeep_V_1_state_cmp_full);
