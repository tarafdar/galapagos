...
void axiStreamGate::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state4.read()) && 
             (esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) || 
              esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) || 
              !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_last_V_reg_136.read())) && 
             !(!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) && esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read())))) {
            ap_reg_ioackin_programSafe_dummy_ack = ap_const_logic_0;
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_102_p2.read()))) {
        tmp_1_reg_127 = tmp_1_nbreadreq_fu_66_p5.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && !(esl_seteq<1,1,1>(packetIn_TVALID.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read())))) {
...
void axiStreamGate::thread_packetIn_TREADY() {
    if (((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
          !(esl_seteq<1,1,1>(packetIn_TVALID.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read()))))) {
...
void axiStreamGate::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_102_p2.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_nbreadreq_fu_66_p5.read()))) {
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(packetIn_TVALID.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read()))) {
                ap_NS_fsm = ap_ST_fsm_state4;
            } else {
                ap_NS_fsm = ap_ST_fsm_state3;
            }
            break;
        case 8 : 
            if (((esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) || 
  esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) || 
  !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_last_V_reg_136.read())) && !(!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) && esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read())))) {
                ap_NS_fsm = ap_ST_fsm_state5;
            } else if ((!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_last_V_reg_136.read()) && !(!esl_seteq<1,1,1>(ap_const_lv1_0, tmp_reg_123.read()) && !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_1_reg_127.read()) && esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_data_V_1_ack_in.read())))) {
                ap_NS_fsm = ap_ST_fsm_state3;
            } else {
                ap_NS_fsm = ap_ST_fsm_state4;
            }
