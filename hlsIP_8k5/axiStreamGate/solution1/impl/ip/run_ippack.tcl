...
set Library     "hls"
set IPName      "axiStreamGate"
set Version     "1.0"
set DisplayName "Axistreamgate"
set Revision    "1706301906"
set Description "An IP generated by Vivado HLS"
set Device      "kintexu"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "axiStreamGate"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 programming W 0x0 "Data signal of programming" {{0 32 programming W 0 "Bit 31 to 0 Data signal of programming"}}} {0x18 programSafe R 0x0 "Data signal of programSafe" {{0 32 programSafe R 0 "Bit 31 to 0 Data signal of programSafe"}}} {0x1c programSafe_ctrl R 0x0 "Control signal of programSafe" {{0 1 programSafe_ap_vld R 0 "Control signal programSafe_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS packetIn packetOut"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
set enable_xo_gen 0
set kernel_files {/home/tarafdar/thesis/gitStuff/hlsSources/srcs/axiStreamGate.cpp}
if {$enable_xo_gen} {
