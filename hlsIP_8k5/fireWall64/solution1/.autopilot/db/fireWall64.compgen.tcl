...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TDEST { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_eth_address_V \
    op interface \
    ports { eth_address_V { I 48 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { observedAddress_out_V { I 48 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_dest_out_V \
    op interface \
    ports { dest_out_V { O 16 vector } dest_out_V_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_match_out_V \
    op interface \
    ports { match_out_V { O 1 vector } match_out_V_ap_vld { O 1 bit } } \
} "
}
