...
architecture behav of packetFormatter_hardcode_64 is 
    ...
    "packetFormatter_hardcode_64,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=464,HLS_SYN_LUT=267}";
    ...
    constant ap_const_lv24_740000 : STD_LOGIC_VECTOR (23 downto 0) := "011101000000000000000000";
    ...
    signal tmp_reg_165 : STD_LOGIC_VECTOR (15 downto 0);
    signal temp_V_fu_126_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal temp_V_reg_170 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_data_V_1_fu_130_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_dest_V_reg_180 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Result_s_fu_141_p4 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = packetIn_V_dest_V_0_ack_out) and (ap_const_logic_1 = packetIn_V_dest_V_0_vld_out))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = packetIn_V_dest_V_0_vld_in) and (ap_const_logic_1 = packetIn_V_dest_V_0_ack_in))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = packetIn_V_keep_V_0_ack_out) and (ap_const_logic_1 = packetIn_V_keep_V_0_vld_out))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_logic_1 = packetIn_V_keep_V_0_vld_in) and (ap_const_logic_1 = packetIn_V_keep_V_0_ack_in))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = packetIn_V_dest_V_0_load_A)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = packetIn_V_dest_V_0_load_B)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = packetIn_V_keep_V_0_load_A)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = packetIn_V_keep_V_0_load_B)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state1))) then
                ...
                tmp_reg_165 <= eth_src_V(47 downto 32);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in))))) then
                tmp_last_V_reg_190 <= packetIn_V_last_V_0_data_out;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm, tmp_last_V_reg_190, ap_condition_547)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state7 => 
                if ((not((ap_const_lv1_0 = tmp_last_V_reg_190)) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in) or (ap_condition_547 = ap_const_boolean_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_lv1_0 = tmp_last_V_reg_190) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in) or (ap_condition_547 = ap_const_boolean_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
    ...
    ap_condition_547_assign_proc : process(packetOut_V_data_V_1_ack_in, packetOut_V_last_V_1_ack_in, packetOut_V_keep_V_1_ack_in)
    begin
                ap_condition_547 <= ((packetOut_V_data_V_1_ack_in = ap_const_logic_0) or (packetOut_V_last_V_1_ack_in = ap_const_logic_0) or (packetOut_V_keep_V_1_ack_in = ap_const_logic_0));
    end process;
    ...
    p_Result_s_fu_141_p4 <= ((temp_V_reg_170 & ap_const_lv24_740000) & tmp_dest_V_reg_180);

    packetIn_TDATA_blk_n_assign_proc : process(packetIn_V_data_V_0_state, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2)) or ((ap_const_lv1_1 = ap_CS_fsm_state6)))) then 
    ...
    packetIn_V_data_V_0_ack_out_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    packetIn_V_dest_V_0_ack_out_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    begin
        if ((ap_const_logic_1 = packetIn_V_dest_V_0_sel)) then 
    ...
    packetIn_V_dest_V_0_load_B <= (packetIn_V_dest_V_0_sel_wr and packetIn_V_dest_V_0_state_cmp_full);
    ...
    packetIn_V_keep_V_0_ack_out_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    begin
        if ((ap_const_logic_1 = packetIn_V_keep_V_0_sel)) then 
    ...
    packetIn_V_keep_V_0_load_B <= (packetIn_V_keep_V_0_sel_wr and packetIn_V_keep_V_0_state_cmp_full);
    ...
    packetIn_V_last_V_0_ack_out_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    packetOut_TDATA_blk_n_assign_proc : process(packetOut_V_data_V_1_state, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state7)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2)) or ((ap_const_lv1_1 = ap_CS_fsm_state6)) or ((ap_const_lv1_1 = ap_CS_fsm_state3)) or ((ap_const_lv1_1 = ap_CS_fsm_state4)) or ((ap_const_lv1_1 = ap_CS_fsm_state5)) or ((ap_const_lv1_1 = ap_CS_fsm_state7)))) then 
    ...
    packetOut_V_data_V_1_data_in_assign_proc : process(packetIn_V_data_V_0_data_out, packetIn_V_data_V_0_vld_out, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4, reg_111, tmp_data_V_1_fu_130_p3, p_Result_s_fu_141_p4)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state6) and not((packetIn_V_data_V_0_vld_out = ap_const_logic_0)))) then 
        ...
        elsif (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((packetIn_V_data_V_0_vld_out = ap_const_logic_0)))) then 
    ...
    packetOut_V_data_V_1_vld_in_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state4) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    packetOut_V_keep_V_1_data_in_assign_proc : process(packetIn_V_data_V_0_vld_out, packetIn_V_keep_V_0_data_out, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state6) and not((packetIn_V_data_V_0_vld_out = ap_const_logic_0)))) then 
            packetOut_V_keep_V_1_data_in <= packetIn_V_keep_V_0_data_out;
        elsif ((((ap_const_lv1_1 = ap_CS_fsm_state3)) or ((ap_const_lv1_1 = ap_CS_fsm_state4)) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and not((packetIn_V_data_V_0_vld_out = ap_const_logic_0))))) then 
    ...
    packetOut_V_keep_V_1_vld_in_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state4) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    packetOut_V_last_V_1_data_in_assign_proc : process(packetIn_V_data_V_0_vld_out, packetIn_V_last_V_0_data_out, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state6) and not((packetIn_V_data_V_0_vld_out = ap_const_logic_0)))) then 
    ...
    packetOut_V_last_V_1_vld_in_assign_proc : process(packetIn_V_data_V_0_vld_out, packetOut_V_data_V_1_ack_in, ap_CS_fsm_state2, ap_CS_fsm_state6, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if ((((ap_const_lv1_1 = ap_CS_fsm_state2) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state6) and not(((packetIn_V_data_V_0_vld_out = ap_const_logic_0) or (ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state3) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))) or ((ap_const_lv1_1 = ap_CS_fsm_state4) and not(((ap_const_logic_0 = packetOut_V_data_V_1_ack_in)))))) then 
    ...
    temp_V_fu_126_p1 <= eth_src_V(32 - 1 downto 0);
    tmp_data_V_1_fu_130_p3 <= (eth_dst_V & tmp_reg_165);
end behav;
