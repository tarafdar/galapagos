; ModuleID = '/home/tarafdar/thesis/gitStuff/hlsIP_8k5/heartBeat/solution1/.autopilot/db/a.o.2.bc'
...
define void @heartBeat(i48 %eth_address_V, i64* %stream_out_V_data_V, i1* %stream_out_V_last_V, i8* %stream_out_V_keep_V) {
  ...
  %tmp_data_V = call i64 @_ssdm_op_BitConcatenate.i64.i48.i16(i48 -1, i16 %tmp)
  ...
  call void @_ssdm_op_Write.axis.volatile.i64P.i1P.i8P(i64* %stream_out_V_data_V, i1* %stream_out_V_last_V, i8* %stream_out_V_keep_V, i64 %tmp_data_V, i1 undef, i8 -1)
