...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("packetOut_TDEST", 8, hls_out, 5, "axis", "out_data", 1),
	Port_Property("base_V", 8, hls_in, 6, "ap_none", "in_data", 1),
	Port_Property("max_V", 8, hls_in, 7, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "roundRobin";
