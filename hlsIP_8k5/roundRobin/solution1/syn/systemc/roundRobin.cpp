...
const sc_logic roundRobin::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic roundRobin::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<4> roundRobin::ap_ST_fsm_state1 = "1";
const sc_lv<4> roundRobin::ap_ST_fsm_state2 = "10";
const sc_lv<4> roundRobin::ap_ST_fsm_state3 = "100";
const sc_lv<4> roundRobin::ap_ST_fsm_state4 = "1000";
const sc_lv<1> roundRobin::ap_const_lv1_0 = "0";
const sc_lv<1> roundRobin::ap_const_lv1_1 = "1";
const sc_lv<2> roundRobin::ap_const_lv2_0 = "00";
const sc_lv<2> roundRobin::ap_const_lv2_2 = "10";
const sc_lv<2> roundRobin::ap_const_lv2_3 = "11";
const sc_lv<2> roundRobin::ap_const_lv2_1 = "1";
const sc_lv<32> roundRobin::ap_const_lv32_2 = "10";
const sc_lv<32> roundRobin::ap_const_lv32_3 = "11";
const sc_lv<32> roundRobin::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<9> roundRobin::ap_const_lv9_1 = "1";

roundRobin::roundRobin(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_index_1_cast_fu_125_p2);
    sensitive << ( tmp_2_fu_121_p1 );

    SC_METHOD(thread_index_1_index_cast_fu_138_p1);
    sensitive << ( index_1_index_fu_131_p3 );

    SC_METHOD(thread_index_1_index_fu_131_p3);
    sensitive << ( index_cast_reg_159 );
    sensitive << ( tmp_1_fu_115_p2 );
    sensitive << ( index_1_cast_fu_125_p2 );

    SC_METHOD(thread_index_cast_fu_89_p1);
    sensitive << ( base_V );

    SC_METHOD(thread_index_fu_85_p1);
    sensitive << ( base_V );

    SC_METHOD(thread_packetIn_TDATA_blk_n);
    sensitive << ( packetIn_V_packet_V_0_state );
    ...
    sensitive << ( packetIn_V_packet_V_0_vld_out );
    ...
    SC_METHOD(thread_packetIn_V_packet_V_0_ack_in);
    sensitive << ( packetIn_V_packet_V_0_state );

    SC_METHOD(thread_packetIn_V_packet_V_0_ack_out);
    sensitive << ( packetIn_V_packet_V_0_vld_out );
    sensitive << ( packetOut_V_packet_V_1_ack_in );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_packetIn_V_packet_V_0_data_out);
    sensitive << ( packetIn_V_packet_V_0_payload_A );
    sensitive << ( packetIn_V_packet_V_0_payload_B );
    sensitive << ( packetIn_V_packet_V_0_sel );

    SC_METHOD(thread_packetIn_V_packet_V_0_load_A);
    sensitive << ( packetIn_V_packet_V_0_sel_wr );
    sensitive << ( packetIn_V_packet_V_0_state_cmp_full );

    SC_METHOD(thread_packetIn_V_packet_V_0_load_B);
    sensitive << ( packetIn_V_packet_V_0_sel_wr );
    sensitive << ( packetIn_V_packet_V_0_state_cmp_full );

    SC_METHOD(thread_packetIn_V_packet_V_0_sel);
    sensitive << ( packetIn_V_packet_V_0_sel_rd );

    SC_METHOD(thread_packetIn_V_packet_V_0_state_cmp_full);
    sensitive << ( packetIn_V_packet_V_0_state );

    SC_METHOD(thread_packetIn_V_packet_V_0_vld_in);
    sensitive << ( packetIn_TVALID );

    SC_METHOD(thread_packetIn_V_packet_V_0_vld_out);
    sensitive << ( packetIn_V_packet_V_0_state );
    ...
    SC_METHOD(thread_packetOut_V_dest_V_1_ack_in);
    sensitive << ( packetOut_V_dest_V_1_state );
    ...
    sensitive << ( packetOut_V_dest_V_1_payload_A );
    sensitive << ( packetOut_V_dest_V_1_payload_B );
    sensitive << ( packetOut_V_dest_V_1_sel );

    SC_METHOD(thread_packetOut_V_dest_V_1_load_A);
    sensitive << ( packetOut_V_dest_V_1_sel_wr );
    sensitive << ( packetOut_V_dest_V_1_state_cmp_full );

    SC_METHOD(thread_packetOut_V_dest_V_1_load_B);
    sensitive << ( packetOut_V_dest_V_1_sel_wr );
    sensitive << ( packetOut_V_dest_V_1_state_cmp_full );
    ...
    SC_METHOD(thread_packetOut_V_dest_V_1_state_cmp_full);
    sensitive << ( packetOut_V_dest_V_1_state );
    ...
    sensitive << ( packetOut_V_packet_V_1_ack_in );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( tmp_last_V_fu_106_p1 );
    sensitive << ( val_assign_fu_46 );
    sensitive << ( tmp_fu_111_p1 );

    SC_METHOD(thread_tmp_2_fu_121_p1);
    sensitive << ( val_assign_fu_46 );

    SC_METHOD(thread_tmp_3_fu_147_p1);
    sensitive << ( val_assign_fu_46 );

    SC_METHOD(thread_tmp_fu_111_p1);
    sensitive << ( max_V );

    SC_METHOD(thread_tmp_last_V_fu_106_p1);
    ...
    packetIn_V_packet_V_0_sel_rd = SC_LOGIC_0;
    packetIn_V_packet_V_0_sel_wr = SC_LOGIC_0;
    packetIn_V_packet_V_0_state = "00";
    ...
    packetOut_V_dest_V_1_sel_wr = SC_LOGIC_0;
    packetOut_V_dest_V_1_state = "00";
    ap_CS_fsm = "0001";
    static int apTFileNum = 0;
    stringstream apTFilenSS;
    apTFilenSS << "roundRobin_sc_trace_" << apTFileNum ++;
    ...
    sc_trace(mVcdFile, base_V, "(port)base_V");
    sc_trace(mVcdFile, max_V, "(port)max_V");
#endif
#ifdef __HLS_TRACE_LEVEL_INT__
    sc_trace(mVcdFile, ap_rst_n_inv, "ap_rst_n_inv");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_data_out, "packetIn_V_packet_V_0_data_out");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_vld_in, "packetIn_V_packet_V_0_vld_in");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_vld_out, "packetIn_V_packet_V_0_vld_out");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_ack_in, "packetIn_V_packet_V_0_ack_in");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_ack_out, "packetIn_V_packet_V_0_ack_out");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_payload_A, "packetIn_V_packet_V_0_payload_A");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_payload_B, "packetIn_V_packet_V_0_payload_B");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_sel_rd, "packetIn_V_packet_V_0_sel_rd");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_sel_wr, "packetIn_V_packet_V_0_sel_wr");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_sel, "packetIn_V_packet_V_0_sel");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_load_A, "packetIn_V_packet_V_0_load_A");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_load_B, "packetIn_V_packet_V_0_load_B");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_state, "packetIn_V_packet_V_0_state");
    sc_trace(mVcdFile, packetIn_V_packet_V_0_state_cmp_full, "packetIn_V_packet_V_0_state_cmp_full");
    ...
    sc_trace(mVcdFile, packetOut_V_dest_V_1_ack_in, "packetOut_V_dest_V_1_ack_in");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_ack_out, "packetOut_V_dest_V_1_ack_out");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_payload_A, "packetOut_V_dest_V_1_payload_A");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_payload_B, "packetOut_V_dest_V_1_payload_B");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_sel_rd, "packetOut_V_dest_V_1_sel_rd");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_sel_wr, "packetOut_V_dest_V_1_sel_wr");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_sel, "packetOut_V_dest_V_1_sel");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_load_A, "packetOut_V_dest_V_1_load_A");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_load_B, "packetOut_V_dest_V_1_load_B");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_state, "packetOut_V_dest_V_1_state");
    sc_trace(mVcdFile, packetOut_V_dest_V_1_state_cmp_full, "packetOut_V_dest_V_1_state_cmp_full");
    ...
    sc_trace(mVcdFile, index_cast_fu_89_p1, "index_cast_fu_89_p1");
    sc_trace(mVcdFile, index_cast_reg_159, "index_cast_reg_159");
    sc_trace(mVcdFile, ap_CS_fsm_state1, "ap_CS_fsm_state1");
    sc_trace(mVcdFile, tmp_last_V_fu_106_p1, "tmp_last_V_fu_106_p1");
    sc_trace(mVcdFile, tmp_3_fu_147_p1, "tmp_3_fu_147_p1");
    sc_trace(mVcdFile, val_assign_fu_46, "val_assign_fu_46");
    sc_trace(mVcdFile, index_fu_85_p1, "index_fu_85_p1");
    sc_trace(mVcdFile, index_1_index_cast_fu_138_p1, "index_1_index_cast_fu_138_p1");
    sc_trace(mVcdFile, tmp_fu_111_p1, "tmp_fu_111_p1");
    sc_trace(mVcdFile, tmp_2_fu_121_p1, "tmp_2_fu_121_p1");
    sc_trace(mVcdFile, tmp_1_fu_115_p2, "tmp_1_fu_115_p2");
    sc_trace(mVcdFile, index_1_cast_fu_125_p2, "index_1_cast_fu_125_p2");
    sc_trace(mVcdFile, index_1_index_fu_131_p3, "index_1_index_fu_131_p3");
    sc_trace(mVcdFile, ap_NS_fsm, "ap_NS_fsm");
#endif

    }
    mHdltvinHandle.open("roundRobin.hdltvin.dat");
    mHdltvoutHandle.open("roundRobin.hdltvout.dat");
}
...
void roundRobin::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_ack_out.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_vld_out.read()))) {
            packetIn_V_packet_V_0_sel_rd =  (sc_logic) (~packetIn_V_packet_V_0_sel_rd.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        packetIn_V_packet_V_0_sel_wr = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_vld_in.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_ack_in.read()))) {
            packetIn_V_packet_V_0_sel_wr =  (sc_logic) (~packetIn_V_packet_V_0_sel_wr.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        packetIn_V_packet_V_0_state = ap_const_lv2_0;
    } else {
        if (((esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_vld_in.read()) && 
              esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_ack_out.read()) && 
              esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_3)) || 
             (esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_vld_in.read()) && 
              esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_2)))) {
            packetIn_V_packet_V_0_state = ap_const_lv2_2;
        } else if (((esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_vld_in.read()) && 
                     esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_3)) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_1)))) {
            packetIn_V_packet_V_0_state = ap_const_lv2_1;
                    ...
                    (esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_1)) || 
                    (esl_seteq<1,2,2>(packetIn_V_packet_V_0_state.read(), ap_const_lv2_3) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_ack_out.read())) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_0, packetIn_V_packet_V_0_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_ack_out.read()))))) {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_dest_V_1_vld_in.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_dest_V_1_ack_in.read()))) {
            packetOut_V_dest_V_1_sel_wr =  (sc_logic) (~packetOut_V_dest_V_1_sel_wr.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_vld_in.read()) && 
              ...
              esl_seteq<1,2,2>(ap_const_lv2_3, packetOut_V_packet_V_1_state.read())) || 
             (esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_vld_in.read()) && 
              esl_seteq<1,2,2>(ap_const_lv2_2, packetOut_V_packet_V_1_state.read())))) {
            packetOut_V_packet_V_1_state = ap_const_lv2_2;
                     ...
                     esl_seteq<1,2,2>(ap_const_lv2_3, packetOut_V_packet_V_1_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, packetOut_V_packet_V_1_state.read())))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())) && 
         !esl_seteq<1,1,1>(ap_const_lv1_0, tmp_last_V_fu_106_p1.read()))) {
        val_assign_fu_46 = index_1_index_cast_fu_138_p1.read();
    } else if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state1.read()))) {
        val_assign_fu_46 = index_fu_85_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state1.read()))) {
        index_cast_reg_159 = index_cast_fu_89_p1.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_load_A.read())) {
        packetIn_V_packet_V_0_payload_A = packetIn_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_load_B.read())) {
        packetIn_V_packet_V_0_payload_B = packetIn_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_dest_V_1_load_A.read())) {
        packetOut_V_dest_V_1_payload_A = tmp_3_fu_147_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_dest_V_1_load_B.read())) {
        packetOut_V_dest_V_1_payload_B = tmp_3_fu_147_p1.read();
    }
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_packet_V_1_load_A.read())) {
        packetOut_V_packet_V_1_payload_A = packetIn_V_packet_V_0_data_out.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_packet_V_1_load_B.read())) {
        packetOut_V_packet_V_1_payload_B = packetIn_V_packet_V_0_data_out.read();
    }
}

void roundRobin::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read().range(0, 0);
}

void roundRobin::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read().range(2, 2);
}

void roundRobin::thread_ap_CS_fsm_state4() {
    ap_CS_fsm_state4 = ap_CS_fsm.read().range(3, 3);
}

void roundRobin::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void roundRobin::thread_index_1_cast_fu_125_p2() {
    index_1_cast_fu_125_p2 = (!ap_const_lv9_1.is_01() || !tmp_2_fu_121_p1.read().is_01())? sc_lv<9>(): (sc_biguint<9>(ap_const_lv9_1) + sc_biguint<9>(tmp_2_fu_121_p1.read()));
}

void roundRobin::thread_index_1_index_cast_fu_138_p1() {
    index_1_index_cast_fu_138_p1 = esl_sext<32,9>(index_1_index_fu_131_p3.read());
}

void roundRobin::thread_index_1_index_fu_131_p3() {
    index_1_index_fu_131_p3 = (!tmp_1_fu_115_p2.read()[0].is_01())? sc_lv<9>(): ((tmp_1_fu_115_p2.read()[0].to_bool())? index_1_cast_fu_125_p2.read(): index_cast_reg_159.read());
}

void roundRobin::thread_index_cast_fu_89_p1() {
    index_cast_fu_89_p1 = esl_sext<9,8>(base_V.read());
}

void roundRobin::thread_index_fu_85_p1() {
    index_fu_85_p1 = esl_sext<32,8>(base_V.read());
}

void roundRobin::thread_packetIn_TDATA_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()))) {
        packetIn_TDATA_blk_n =  (sc_logic) (packetIn_V_packet_V_0_state.read()[0]);
    } else {
        packetIn_TDATA_blk_n = ap_const_logic_1;
    }
}

void roundRobin::thread_packetIn_TREADY() {
    packetIn_TREADY =  (sc_logic) (packetIn_V_dest_V_0_state.read()[1]);
}

void roundRobin::thread_packetIn_V_dest_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetIn_V_dest_V_0_vld_in() {
    packetIn_V_dest_V_0_vld_in = packetIn_TVALID.read();
}

void roundRobin::thread_packetIn_V_last_V_0_ack_in() {
    packetIn_V_last_V_0_ack_in =  (sc_logic) (packetIn_V_last_V_0_state.read()[1]);
}

void roundRobin::thread_packetIn_V_last_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetIn_V_last_V_0_data_out() {
...
void roundRobin::thread_packetIn_V_last_V_0_vld_in() {
    packetIn_V_last_V_0_vld_in = packetIn_TVALID.read();
}

void roundRobin::thread_packetIn_V_last_V_0_vld_out() {
    packetIn_V_last_V_0_vld_out =  (sc_logic) (packetIn_V_last_V_0_state.read()[0]);
}

void roundRobin::thread_packetIn_V_packet_V_0_ack_in() {
    packetIn_V_packet_V_0_ack_in =  (sc_logic) (packetIn_V_packet_V_0_state.read()[1]);
}

void roundRobin::thread_packetIn_V_packet_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetIn_V_packet_V_0_data_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetIn_V_packet_V_0_sel.read())) {
        packetIn_V_packet_V_0_data_out = packetIn_V_packet_V_0_payload_B.read();
    } else {
        packetIn_V_packet_V_0_data_out = packetIn_V_packet_V_0_payload_A.read();
    }
}

void roundRobin::thread_packetIn_V_packet_V_0_load_A() {
    packetIn_V_packet_V_0_load_A = (packetIn_V_packet_V_0_state_cmp_full.read() & ~packetIn_V_packet_V_0_sel_wr.read());
}

void roundRobin::thread_packetIn_V_packet_V_0_load_B() {
    packetIn_V_packet_V_0_load_B = (packetIn_V_packet_V_0_sel_wr.read() & packetIn_V_packet_V_0_state_cmp_full.read());
}

void roundRobin::thread_packetIn_V_packet_V_0_sel() {
    packetIn_V_packet_V_0_sel = packetIn_V_packet_V_0_sel_rd.read();
}

void roundRobin::thread_packetIn_V_packet_V_0_state_cmp_full() {
    packetIn_V_packet_V_0_state_cmp_full =  (sc_logic) ((!packetIn_V_packet_V_0_state.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<1>(): sc_lv<1>(packetIn_V_packet_V_0_state.read() != ap_const_lv2_1))[0];
}

void roundRobin::thread_packetIn_V_packet_V_0_vld_in() {
    packetIn_V_packet_V_0_vld_in = packetIn_TVALID.read();
}

void roundRobin::thread_packetIn_V_packet_V_0_vld_out() {
    packetIn_V_packet_V_0_vld_out =  (sc_logic) (packetIn_V_packet_V_0_state.read()[0]);
}

void roundRobin::thread_packetOut_TDATA() {
    packetOut_TDATA = packetOut_V_packet_V_1_data_out.read();
}

void roundRobin::thread_packetOut_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read())) || 
...
void roundRobin::thread_packetOut_TDEST() {
    packetOut_TDEST = packetOut_V_dest_V_1_data_out.read();
}

void roundRobin::thread_packetOut_TLAST() {
    packetOut_TLAST = packetOut_V_last_V_1_data_out.read();
}

void roundRobin::thread_packetOut_TVALID() {
    packetOut_TVALID =  (sc_logic) (packetOut_V_dest_V_1_state.read()[0]);
}

void roundRobin::thread_packetOut_V_dest_V_1_ack_in() {
    packetOut_V_dest_V_1_ack_in =  (sc_logic) (packetOut_V_dest_V_1_state.read()[1]);
}

void roundRobin::thread_packetOut_V_dest_V_1_ack_out() {
    packetOut_V_dest_V_1_ack_out = packetOut_TREADY.read();
}

void roundRobin::thread_packetOut_V_dest_V_1_data_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, packetOut_V_dest_V_1_sel.read())) {
        packetOut_V_dest_V_1_data_out = packetOut_V_dest_V_1_payload_B.read();
    } else {
        packetOut_V_dest_V_1_data_out = packetOut_V_dest_V_1_payload_A.read();
    }
}

void roundRobin::thread_packetOut_V_dest_V_1_load_A() {
    packetOut_V_dest_V_1_load_A = (packetOut_V_dest_V_1_state_cmp_full.read() & ~packetOut_V_dest_V_1_sel_wr.read());
}

void roundRobin::thread_packetOut_V_dest_V_1_load_B() {
    packetOut_V_dest_V_1_load_B = (packetOut_V_dest_V_1_sel_wr.read() & packetOut_V_dest_V_1_state_cmp_full.read());
}

void roundRobin::thread_packetOut_V_dest_V_1_sel() {
    packetOut_V_dest_V_1_sel = packetOut_V_dest_V_1_sel_rd.read();
}

void roundRobin::thread_packetOut_V_dest_V_1_state_cmp_full() {
    packetOut_V_dest_V_1_state_cmp_full =  (sc_logic) ((!packetOut_V_dest_V_1_state.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<1>(): sc_lv<1>(packetOut_V_dest_V_1_state.read() != ap_const_lv2_1))[0];
}

void roundRobin::thread_packetOut_V_dest_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetOut_V_dest_V_1_vld_out() {
    packetOut_V_dest_V_1_vld_out =  (sc_logic) (packetOut_V_dest_V_1_state.read()[0]);
}

void roundRobin::thread_packetOut_V_last_V_1_ack_in() {
    packetOut_V_last_V_1_ack_in =  (sc_logic) (packetOut_V_last_V_1_state.read()[1]);
}

void roundRobin::thread_packetOut_V_last_V_1_ack_out() {
    packetOut_V_last_V_1_ack_out = packetOut_TREADY.read();
}

void roundRobin::thread_packetOut_V_last_V_1_data_out() {
...
void roundRobin::thread_packetOut_V_last_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetOut_V_last_V_1_vld_out() {
    packetOut_V_last_V_1_vld_out =  (sc_logic) (packetOut_V_last_V_1_state.read()[0]);
}

void roundRobin::thread_packetOut_V_packet_V_1_ack_in() {
    packetOut_V_packet_V_1_ack_in =  (sc_logic) (packetOut_V_packet_V_1_state.read()[1]);
}

void roundRobin::thread_packetOut_V_packet_V_1_ack_out() {
    packetOut_V_packet_V_1_ack_out = packetOut_TREADY.read();
}

void roundRobin::thread_packetOut_V_packet_V_1_data_out() {
...
void roundRobin::thread_packetOut_V_packet_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state3.read()) && 
         !(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())))) {
...
void roundRobin::thread_packetOut_V_packet_V_1_vld_out() {
    packetOut_V_packet_V_1_vld_out =  (sc_logic) (packetOut_V_packet_V_1_state.read()[0]);
}

void roundRobin::thread_tmp_1_fu_115_p2() {
    tmp_1_fu_115_p2 = (!val_assign_fu_46.read().is_01() || !tmp_fu_111_p1.read().is_01())? sc_lv<1>(): sc_lv<1>(val_assign_fu_46.read() == tmp_fu_111_p1.read());
}

void roundRobin::thread_tmp_2_fu_121_p1() {
    tmp_2_fu_121_p1 = val_assign_fu_46.read().range(9-1, 0);
}

void roundRobin::thread_tmp_3_fu_147_p1() {
    tmp_3_fu_147_p1 = val_assign_fu_46.read().range(8-1, 0);
}

void roundRobin::thread_tmp_fu_111_p1() {
    tmp_fu_111_p1 = esl_sext<32,8>(max_V.read());
}

void roundRobin::thread_tmp_last_V_fu_106_p1() {
    tmp_last_V_fu_106_p1 = packetIn_V_last_V_0_data_out.read();
}

void roundRobin::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(packetIn_V_packet_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read()))) {
            ...
            break;
        case 8 : 
            if (!esl_seteq<1,1,1>(ap_const_logic_0, packetOut_V_packet_V_1_ack_in.read())) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else {
                ap_NS_fsm = ap_ST_fsm_state4;
            }
...
void roundRobin::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvinHandle << " , " <<  " \"base_V\" :  \"" << base_V.read() << "\" ";
