...
connect_bd_net [get_bd_ports CLK] [get_bd_pins dariusWrapper_inst/ap_clk]
connect_bd_net [get_bd_ports ARESETN] [get_bd_pins dariusWrapper_inst/ap_rst_n]
...
set_property offset 0x0000000000000000 [get_bd_addr_segs {dariusWrapper_inst/Data_m_axi_mem/SEG_M_AXI_MEM_Reg}]
set_property range 1G [get_bd_addr_segs {dariusWrapper_inst/Data_m_axi_mem/SEG_M_AXI_MEM_Reg}]
...
set_property range 1G [get_bd_addr_segs {cnn_dataflow_v2_0_inst/m_axi_cmd/SEG_M_AXI_MEM_Reg}]
set_property range 1G [get_bd_addr_segs {cnn_dataflow_v2_0_inst/m_axi_ifm/SEG_M_AXI_MEM_Reg}]
set_property range 1G [get_bd_addr_segs {cnn_dataflow_v2_0_inst/m_axi_ofm/SEG_M_AXI_MEM_Reg}]
set_property range 1G [get_bd_addr_segs {cnn_dataflow_v2_0_inst/m_axi_weight/SEG_M_AXI_MEM_Reg}]
