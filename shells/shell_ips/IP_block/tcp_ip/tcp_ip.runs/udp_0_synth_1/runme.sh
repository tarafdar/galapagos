...
HD_PWD='/home/madanie1/Documents/2017.4/8v3/repo/tcp_ip/tcp_ip.runs/udp_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udp_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udp_0.tcl
