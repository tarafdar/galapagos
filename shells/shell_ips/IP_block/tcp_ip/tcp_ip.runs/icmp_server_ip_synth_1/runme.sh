...
HD_PWD='/home/madanie1/Documents/2017.4/8v3/repo/tcp_ip/tcp_ip.runs/icmp_server_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icmp_server_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icmp_server_ip.tcl
