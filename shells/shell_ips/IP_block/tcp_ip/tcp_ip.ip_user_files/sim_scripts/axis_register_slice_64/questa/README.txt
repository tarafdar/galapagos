...
#
# Generated by export_simulation on Mon Apr 09 17:59:58 EST 2018
#
################################################################################
...
'-reset_run' switch to the './axis_register_slice_64.sh' script.

./axis_register_slice_64.sh -reset_run
...
./axis_register_slice_64.sh -noclean_files

For more information on the script, please type './axis_register_slice_64.sh -help'.
