...
#
# Generated by export_simulation on Mon Apr 09 17:59:51 EST 2018
#
################################################################################
...
'-reset_run' switch to the './axis_interconnect_2to1.sh' script.

./axis_interconnect_2to1.sh -reset_run
...
./axis_interconnect_2to1.sh -noclean_files

For more information on the script, please type './axis_interconnect_2to1.sh -help'.
