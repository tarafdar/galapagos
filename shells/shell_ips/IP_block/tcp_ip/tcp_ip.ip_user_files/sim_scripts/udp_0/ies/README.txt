...
#
# Generated by export_simulation on Mon Apr 09 18:00:26 EST 2018
#
################################################################################
...
'-reset_run' switch to the './udp_0.sh' script.
...
./udp_0.sh -noclean_files

For more information on the script, please type './udp_0.sh -help'.
