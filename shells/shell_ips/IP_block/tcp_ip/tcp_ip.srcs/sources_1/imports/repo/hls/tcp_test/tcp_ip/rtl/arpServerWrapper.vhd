...
COMPONENT SmartCamCtlArp is
  Port ( 
    ...
    lup_req_din : in STD_LOGIC_VECTOR ( 32 downto 0 );
    lup_rsp_valid : out STD_LOGIC;
    lup_rsp_ready : in STD_LOGIC;
    lup_rsp_dout : out STD_LOGIC_VECTOR ( 48 downto 0 );
    upd_req_valid : in STD_LOGIC;
    upd_req_ready : out STD_LOGIC;
    upd_req_din : in STD_LOGIC_VECTOR ( 81 downto 0 );
    upd_rsp_valid : out STD_LOGIC;
    upd_rsp_ready : in STD_LOGIC;
    upd_rsp_dout : out STD_LOGIC_VECTOR ( 49 downto 0 );
...
-- SmartCam Wrapper
SmartCamCtl_inst: SmartCamCtlArp
                  port map(clk              =>  aclk,
                           rst              =>  invertedReset,
                           led0             =>  open,
                           led1             =>  open,
