...
(* CORE_GENERATION_INFO="arp_server,hls_ip_2015_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7vx690tffg1761-2,HLS_INPUT_CLOCK=6.400000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.234000,HLS_SYN_LAT=1,HLS_SYN_TPT=1,HLS_SYN_MEM=11,HLS_SYN_DSP=0,HLS_SYN_FF=1193,HLS_SYN_LUT=991}" *)
