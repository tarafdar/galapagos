...
module udpAppMux_txLengthOut_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [15:0] txLengthOut_V_V_din,
    output wire        txLengthOut_V_V_full_n,
    input  wire        txLengthOut_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
...
wire [0:0]  txLengthOut_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [15:0] s_data;
...
//------------------------Instantiation------------------
// rs
udpAppMux_txLengthOut_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// txLengthOut_V_V_fifo
udpAppMux_txLengthOut_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) txLengthOut_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( txLengthOut_V_V_empty_n ),
    .full_n     ( txLengthOut_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( txLengthOut_V_V_write ),
    .dout       ( txLengthOut_V_V_dout ),
    .din        ( txLengthOut_V_V_din )
);
...
assign s_data  = {txLengthOut_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = txLengthOut_V_V_empty_n;
...
module udpAppMux_txLengthOut_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module udpAppMux_txLengthOut_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
