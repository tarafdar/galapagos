...
reg   [1:0] ap_phi_mux_storemerge3_i_phi_fu_246_p4;
wire   [1:0] ap_phi_reg_pp0_iter0_storemerge3_i_reg_243;
wire   [63:0] tmp_19_i_fu_389_p1;
...
wire   [2:0] storemerge3_cast_i_fu_394_p1;
wire   [63:0] tmp_27_fu_404_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_206)) begin
        ...
        end else if (((tmp_24_nbreadreq_fu_160_p3 == 1'd1) & (esac_fsmState_V == 3'd4))) begin
            esac_fsmState_V <= storemerge3_cast_i_fu_394_p1;
        end else if (((tmp_25_nbreadreq_fu_146_p3 == 1'd1) & (esac_fsmState_V == 3'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_206)) begin
        if ((ap_predicate_op45_read_state1 == 1'b1)) begin
            packet_data_V <= tmp_27_fu_404_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_predicate_op23_read_state1 == 1'b1))) begin
        tmp_17_i_reg_523 <= grp_fu_309_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_24_nbreadreq_fu_160_p3 == 1'd1) & (esac_fsmState_V == 3'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_i_fu_383_p2 == 1'd0))) begin
        tmp_20_i_reg_541 <= grp_fu_309_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((esac_fsmState_V == 3'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_24_reg_527 <= client_read_sid_V_V_empty_n;
    end
end

always @ (posedge ap_clk) begin
    if (((esac_fsmState_V == 3'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_25_reg_512 <= sessionID_fifo_V_V_empty_n;
    end
end

always @ (posedge ap_clk) begin
    if (((esac_fsmState_V == 3'd3) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_26_reg_493 <= stream_in_V_empty_n;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_475)) begin
        if ((tmp_i_fu_383_p2 == 1'd0)) begin
            ap_phi_mux_storemerge3_i_phi_fu_246_p4 = 2'd2;
        end else if ((tmp_i_fu_383_p2 == 1'd1)) begin
            ap_phi_mux_storemerge3_i_phi_fu_246_p4 = 2'd1;
        end else begin
            ap_phi_mux_storemerge3_i_phi_fu_246_p4 = ap_phi_reg_pp0_iter0_storemerge3_i_reg_243;
        end
    end else begin
        ap_phi_mux_storemerge3_i_phi_fu_246_p4 = ap_phi_reg_pp0_iter0_storemerge3_i_reg_243;
    end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (tmp_31_nbreadreq_fu_174_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_31_nbreadreq_fu_174_p3 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_condition_475 = ((tmp_24_nbreadreq_fu_160_p3 == 1'd1) & (esac_fsmState_V == 3'd4) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_phi_reg_pp0_iter0_storemerge3_i_reg_243 = 'bx;

always @ (*) begin
    ap_predicate_op102_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd4) & (tmp_20_i_reg_541 == 1'd1) & (tmp_24_reg_527 == 1'd1) & (tmp_i_reg_537 == 1'd0));
end

always @ (*) begin
    ap_predicate_op105_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd4) & (tmp_i_reg_537 == 1'd1) & (tmp_24_reg_527 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op23_read_state1 = ((tmp_25_nbreadreq_fu_146_p3 == 1'd1) & (esac_fsmState_V == 3'd1));
end

always @ (*) begin
    ap_predicate_op30_read_state1 = ((tmp_24_nbreadreq_fu_160_p3 == 1'd1) & (esac_fsmState_V == 3'd4));
end
...
always @ (*) begin
    ap_predicate_op75_write_state2 = ((tmp_26_reg_493 == 1'd1) & (esac_fsmState_V_load_reg_473 == 3'd3));
end

always @ (*) begin
    ap_predicate_op85_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd1) & (tmp_25_reg_512 == 1'd1) & (tmp_17_i_reg_523 == 1'd0));
end

always @ (*) begin
    ap_predicate_op90_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd1) & (tmp_17_i_reg_523 == 1'd1) & (tmp_25_reg_512 == 1'd1));
end

always @ (*) begin
    ap_predicate_op92_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd1) & (tmp_25_reg_512 == 1'd1));
end

always @ (*) begin
    ap_predicate_op97_write_state2 = ((esac_fsmState_V_load_reg_473 == 3'd4) & (tmp_24_reg_527 == 1'd1) & (tmp_20_i_reg_541 == 1'd0) & (tmp_i_reg_537 == 1'd0));
end
...
assign ip_table_V_address0 = tmp_19_i_fu_389_p1;

assign storemerge3_cast_i_fu_394_p1 = ap_phi_mux_storemerge3_i_phi_fu_246_p4;

assign storemerge_cast_i_ca_fu_363_p3 = ((packet_last_V_1[0:0] === 1'b1) ? 3'd0 : 3'd3);

assign tmp_19_i_fu_389_p1 = packet_dest_V;

assign tmp_1_fu_457_p3 = {{16'd8}, {tmp_V_18_reg_531}};

assign tmp_24_nbreadreq_fu_160_p3 = client_read_sid_V_V_empty_n;

assign tmp_25_nbreadreq_fu_146_p3 = sessionID_fifo_V_V_empty_n;

assign tmp_27_fu_404_p1 = stream_in_V_dout[63:0];

assign tmp_2_fu_465_p3 = {{grp_fu_324_p2}, {tmp_V_18_reg_531}};

assign tmp_31_nbreadreq_fu_174_p3 = txStatus_V_V_empty_n;
