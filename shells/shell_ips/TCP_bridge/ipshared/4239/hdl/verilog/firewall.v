...
wire   [0:0] tmp_9_nbreadreq_fu_100_p3;
...
reg   [0:0] tmp_14_reg_334;
reg    ap_predicate_op52_write_state2;
reg   [0:0] tmp_8_reg_357;
...
always @ (*) begin
    ap_predicate_op20_read_state1 = ((tmp_9_nbreadreq_fu_100_p3 == 1'd1) & (ksvs_fsmState_V == 3'd4));
end
...
always @ (*) begin
    ap_predicate_op52_write_state2 = ((tmp_14_reg_334 == 1'd1) & (packet_last_V_load_reg_330 == 1'd0) & (ksvs_fsmState_V_load_reg_326 == 3'd3));
end

always @ (*) begin
    ap_predicate_op67_write_state2 = ((ksvs_fsmState_V_load_reg_326 == 3'd1) & (tmp_8_reg_357 == 1'd1));
end
...
assign tmp_9_nbreadreq_fu_100_p3 = firewal_read_sid_V_V_empty_n;
