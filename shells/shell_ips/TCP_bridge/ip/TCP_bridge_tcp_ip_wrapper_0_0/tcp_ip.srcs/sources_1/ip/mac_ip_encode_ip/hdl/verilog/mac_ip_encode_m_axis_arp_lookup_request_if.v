...
module mac_ip_encode_m_axis_arp_lookup_request_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [31:0] arpTableOut_V_V_din,
    output wire        arpTableOut_V_V_full_n,
    input  wire        arpTableOut_V_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
wire [0:0]  fifo_empty_n;
wire [31:0] arpTableOut_V_V_dout;
wire [0:0]  arpTableOut_V_V_empty_n;
// register slice
wire [0:0]  s_valid;
wire [0:0]  s_ready;
wire [31:0] s_data;
...
//------------------------Instantiation------------------
// rs
mac_ip_encode_m_axis_arp_lookup_request_reg_slice #(
    .N       ( 32 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// arpTableOut_V_V_fifo
mac_ip_encode_m_axis_arp_lookup_request_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) arpTableOut_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( arpTableOut_V_V_empty_n ),
    .full_n     ( arpTableOut_V_V_full_n ),
    .read       ( fifo_read ),
    .write      ( arpTableOut_V_V_write ),
    .dout       ( arpTableOut_V_V_dout ),
    .din        ( arpTableOut_V_V_din )
);
...
assign s_data  = {arpTableOut_V_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = arpTableOut_V_V_empty_n;
