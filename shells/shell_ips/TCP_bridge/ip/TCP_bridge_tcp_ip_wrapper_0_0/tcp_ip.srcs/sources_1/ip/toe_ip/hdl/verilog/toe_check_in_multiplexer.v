...
reg    ap_sig_bdd_49;
reg   [0:0] tmp_reg_126;
reg   [0:0] tmp_531_reg_140;
reg    ap_sig_bdd_81;
reg   [7:0] p_Result_s_reg_130;
wire   [6:0] tmp_530_fu_106_p1;
reg   [6:0] tmp_530_reg_135;
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(tmp_nbreadreq_fu_58_p3 == ap_const_lv1_0) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_81 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
        ...
        tmp_530_reg_135 <= tmp_530_fu_106_p1;
        tmp_531_reg_140 <= rxEng2portTable_check_req_V_V_dout[ap_const_lv32_7];
    end
end
...
always @ (tmp_531_reg_140 or ap_sig_bdd_144)
begin
    if (ap_sig_bdd_144) begin
        if (~(ap_const_lv1_0 == tmp_531_reg_140)) begin
            pt_dstFifo_V_din = ap_const_lv1_0;
        end else if ((ap_const_lv1_0 == tmp_531_reg_140)) begin
...
always @ (ap_done_reg or ap_sig_cseq_ST_pp0_stg0_fsm_0 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or ap_sig_bdd_49 or tmp_reg_126 or tmp_531_reg_140 or ap_sig_bdd_81)
begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(ap_const_lv1_0 == tmp_reg_126) & (ap_const_lv1_0 == tmp_531_reg_140) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_81 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) | ((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(ap_const_lv1_0 == tmp_reg_126) & ~(ap_const_lv1_0 == tmp_531_reg_140) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_81 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))))) begin
...
always @ (ap_done_reg or ap_sig_cseq_ST_pp0_stg0_fsm_0 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or ap_sig_bdd_49 or tmp_reg_126 or tmp_531_reg_140 or ap_sig_bdd_81)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & ~(ap_const_lv1_0 == tmp_reg_126) & (ap_const_lv1_0 == tmp_531_reg_140) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_49) | (ap_sig_bdd_81 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
...
always @ (pt_portCheckListening_req_fifo_full_n or tmp_reg_126 or tmp_531_reg_140 or pt_dstFifo_V_full_n or pt_portCheckUsed_req_fifo_V_V_full_n)
begin
    ap_sig_bdd_81 = (((pt_portCheckListening_req_fifo_full_n == ap_const_logic_0) & ~(ap_const_lv1_0 == tmp_reg_126) & (ap_const_lv1_0 == tmp_531_reg_140)) | (~(ap_const_lv1_0 == tmp_reg_126) & (ap_const_lv1_0 == tmp_531_reg_140) & (pt_dstFifo_V_full_n == ap_const_logic_0)) | (~(ap_const_lv1_0 == tmp_reg_126) & (pt_portCheckUsed_req_fifo_V_V_full_n == ap_const_logic_0) & ~(ap_const_lv1_0 == tmp_531_reg_140)) | (~(ap_const_lv1_0 == tmp_reg_126) & (pt_dstFifo_V_full_n == ap_const_logic_0) & ~(ap_const_lv1_0 == tmp_531_reg_140)));
end
assign pt_portCheckListening_req_fifo_din = tmp_V_fu_118_p3;
assign pt_portCheckUsed_req_fifo_V_V_din = tmp_V_fu_118_p3;
assign tmp_530_fu_106_p1 = rxEng2portTable_check_req_V_V_dout[6:0];
assign tmp_V_fu_118_p3 = {{tmp_530_reg_135}, {p_Result_s_reg_130}};
