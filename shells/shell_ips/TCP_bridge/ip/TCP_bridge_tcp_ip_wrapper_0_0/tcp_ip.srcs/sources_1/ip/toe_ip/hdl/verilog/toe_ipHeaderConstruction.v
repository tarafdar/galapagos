...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_0) & (ihc_currWord_V == ap_const_lv2_1) & ~(tmp_nbreadreq_fu_96_p3 == ap_const_lv1_0) & ~((ap_done_reg == ap_const_logic_1) | ((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ap_sig_bdd_66) | (ap_sig_bdd_91 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1))))) begin
        tmp_193_reg_249 <= tmp_193_fu_142_p1;
    end
end
...
always @ (ihc_currWord_V_load_reg_241 or tmp_3_fu_190_p3 or tmp_2_fu_199_p4 or tmp37_fu_228_p5 or ap_sig_bdd_82 or ap_sig_bdd_88 or ap_sig_bdd_117)
begin
    if (ap_sig_bdd_117) begin
        if (ap_sig_bdd_88) begin
            txEng_ipHeaderBuffer_V_din = tmp37_fu_228_p5;
...
assign tmp37_fu_228_p5 = {{{{{{ap_const_lv41_FF00000000}, {tmp_192_fu_224_p1}}}, {p_Result_s_fu_214_p4}}}, {ap_const_lv16_45}};
assign tmp_192_fu_224_p1 = length_V_fu_209_p2[7:0];
assign tmp_193_fu_142_p1 = txEng_ipTupleFifo_V_dout[31:0];
assign tmp_2_fu_199_p4 = {{{{ap_const_lv9_FF}, {tmp_193_reg_249}}}, {ap_const_lv32_640}};
