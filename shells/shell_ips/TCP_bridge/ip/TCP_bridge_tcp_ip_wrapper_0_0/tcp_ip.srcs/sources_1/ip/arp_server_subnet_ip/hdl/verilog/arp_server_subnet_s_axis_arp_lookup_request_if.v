...
module arp_server_subnet_s_axis_arp_lookup_request_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
...
//------------------------Instantiation------------------
// rs
arp_server_subnet_s_axis_arp_lookup_request_reg_slice #(
    .N       ( 32 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
arp_server_subnet_s_axis_arp_lookup_request_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) macIpEncode_req_V_V_fifo (
    .clk        ( ACLK ),
