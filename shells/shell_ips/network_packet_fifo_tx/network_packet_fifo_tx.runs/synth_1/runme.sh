...
HD_PWD='/home/madanie1/Documents/2017.4/8v3/repo/network_packet_fifo_tx/network_packet_fifo_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tx_interface_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tx_interface_wrapper.tcl
