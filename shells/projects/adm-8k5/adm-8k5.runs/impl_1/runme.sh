...
HD_PWD='/nfs/ug/thesis/thesis0/pc/Graham/galapagos_wip/shells/projects/adm-8k5/adm-8k5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shellTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shellTop.tcl -notrace
