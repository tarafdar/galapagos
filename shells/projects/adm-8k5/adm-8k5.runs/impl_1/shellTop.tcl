...
set rc [catch {
  ...
  set_param project.isImplRun false
  write_hwdef -force -file shellTop.hwdef
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force shellTop_opt.dcp
  create_report "impl_1_opt_report_drc_0" "report_drc -file shellTop_drc_opted.rpt -pb shellTop_drc_opted.pb -rpx shellTop_drc_opted.rpx"
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force shellTop_placed.dcp
  create_report "impl_1_place_report_io_0" "report_io -file shellTop_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file shellTop_utilization_placed.rpt -pb shellTop_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file shellTop_control_sets_placed.rpt"
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force shellTop_routed.dcp
  create_report "impl_1_route_report_drc_0" "report_drc -file shellTop_drc_routed.rpt -pb shellTop_drc_routed.pb -rpx shellTop_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file shellTop_methodology_drc_routed.rpt -pb shellTop_methodology_drc_routed.pb -rpx shellTop_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file shellTop_power_routed.rpt -pb shellTop_power_summary_routed.pb -rpx shellTop_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file shellTop_route_status.rpt -pb shellTop_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file shellTop_timing_summary_routed.rpt -pb shellTop_timing_summary_routed.pb -rpx shellTop_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file shellTop_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file shellTop_clock_utilization_routed.rpt"
...
if {$rc} {
  write_checkpoint -force shellTop_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force shellTop.mmi }
  write_bitstream -force shellTop.bit 
  catch { write_sysdef -hwdef shellTop.hwdef -bitfile shellTop.bit -meminfo shellTop.mmi -file shellTop.sysdef }
  catch {write_debug_probes -quiet -force shellTop}
  catch {file copy -force shellTop.ltx debug_nets.ltx}
