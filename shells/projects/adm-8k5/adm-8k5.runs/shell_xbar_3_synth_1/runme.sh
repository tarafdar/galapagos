...
HD_PWD='/nfs/ug/thesis/thesis0/pc/Quinn/galapagos/shells/projects/adm-8k5/adm-8k5.runs/shell_xbar_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shell_xbar_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shell_xbar_3.tcl
