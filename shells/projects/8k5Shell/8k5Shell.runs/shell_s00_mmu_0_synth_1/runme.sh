...
HD_PWD='/home/tarafdar/thesis/MIXcoatl/shells/projects/8k5Shell/8k5Shell.runs/shell_s00_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shell_s00_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shell_s00_mmu_0.tcl
