...
// Command     : write_verilog -force -mode synth_stub -rename_top pr_FNR_0_0 -prefix
//               pr_FNR_0_0_ pr_FNR_0_0_stub.v
// Design      : pr_FNR_0_0
...
(* X_CORE_INFO = "fnr_top,Vivado 2018.1" *)
module pr_FNR_0_0(stream_in_V_TVALID, stream_in_V_TREADY, 
  stream_in_V_TDATA, stream_in_V_TDEST, stream_in_V_TKEEP, stream_in_V_TLAST, 
  stream_in_V_TID, stream_in_V_TUSER, stream_out_V_TVALID, stream_out_V_TREADY, 
  stream_out_V_TDATA, stream_out_V_TLAST, stream_out_V_TKEEP, stream_out_V_TDEST, aclk, 
  aresetn)
