...
set Library     "hls"
set IPName      "dariusController"
set Version     "1.0"
set DisplayName "Dariuscontroller"
set Revision    "1806221148"
...
set Interfaces {
    ...
    M_AXI_DARIUS_DRIVER {
        ...
        mode "master"
        data_width "32"
        port_prefix "m_axi_darius_driver"
        param_prefix "C_M_AXI_DARIUS_DRIVER"
    }
    stream_in_V {
        type "axi4stream"
        mode "slave"
    ...
    aclk {
        type "clock"
        buses "M_AXI_MEM M_AXI_DARIUS_DRIVER stream_in_V stream_out_V"
    }
    aresetn {
        type "reset"
    }
