...
module dariusController_mem_if/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// dariusController_mem_request_preprocessor
dariusController_mem_request_preprocessor #(
...
module dariusController_mem_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module dariusController_mem_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
module dariusController_mem_read/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// dariusController_mem_read_data_align
dariusController_mem_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module dariusController_mem_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
//------------------------Instantiation------------------
// dariusController_mem_reg_slice
dariusController_mem_reg_slice #(
    .N       ( BUS_DATA_WIDTH )
) rs0 (
    .sclk    ( ACLK ),
...
module dariusController_mem_fifo/*{{{*/
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module dariusController_mem_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
