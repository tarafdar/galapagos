set C_TypeInfoList {{ 
"FNR" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"stream_in": [[],"0"] }, {"stream_out": [[],"1"] }],[],""], 
"1": [ "stream<ap_axis>", {"hls_type": {"stream": [[[[],"2"]],"3"]}}], 
"2": [ "ap_axis", {"struct": [[],[],[{ "data": [[], "4"]},{ "last": [[], "5"]},{ "keep": [[], "6"]},{ "dest": [[], "6"]}],""]}], 
"0": [ "stream<ap_axis_dest>", {"hls_type": {"stream": [[[[],"7"]],"3"]}}], 
"7": [ "ap_axis_dest", {"struct": [[],[],[{ "data": [[], "8"]},{ "dest": [[], "6"]},{ "keep": [[], "6"]},{ "last": [[], "5"]},{ "id": [[], "6"]},{ "user": [[], "9"]}],""]}], 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stream_out_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":81, "type": "signal", "bundle":{"name": "stream_out_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	stream_out_V { ap_fifo {  { stream_out_V_din fifo_data 1 81 }  { stream_out_V_full_n fifo_status 0 1 }  { stream_out_V_write fifo_update 1 1 } } }
}
...
set fifoSchedulingInfoList { 
	...
	stream_out_V { fifo_write 4 has_conditional }
}
