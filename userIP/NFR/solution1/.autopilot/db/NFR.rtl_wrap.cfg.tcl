...
set DataType0 [list "ap_axis_in" "struct ap_axis_in" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType15 "[list ap_uint 40 ]"
...
set DataType1 [list "ap_axis_out" "struct ap_axis_out" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
